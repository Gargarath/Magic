...
execute positioned 17 99 0 if entity @s[distance=..4,tag=!in_map_display] at @s if block ~ ~ ~ yellow_carpet run return run function lobby:map_island/jump_pads/launch_in
