...
execute if score selected_map variables = first_map map_memories run function main:map_randomizer/limited_randomization/round4/round4_clock
# si la map est égale à la première map => tire au sort de nouveau
execute if score selected_map variables = second_map map_memories run function main:map_randomizer/limited_randomization/round4/round4_clock
# si la map est égale à la deuxième map => tire au sort de nouveau
execute if score selected_map variables = third_map map_memories run function main:map_randomizer/limited_randomization/round4/round4_clock
# si la map est égale à la deuxième map => tire au sort de nouveau