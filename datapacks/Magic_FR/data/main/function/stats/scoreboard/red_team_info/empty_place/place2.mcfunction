...
function main:stats/scoreboard/red_team_info/save_data/place2
# save la place de @s

execute as @a[scores={red_place=3..},limit=1] if score @a[scores={red_place=2},limit=1] class_id >= @s class_id run function main:stats/scoreboard/red_team_info/sort_red
