...
scoreboard players add @a[tag=red_team,scores={red_place=6..}] red_place 1
# décale de 1 les places de tout les joueurs déjà dans placés


scoreboard players set @s red_place 6

execute as @a[tag=red_team,scores={red_place=6..}] run function main:stats/scoreboard/red_team_info/save_data/check_place
