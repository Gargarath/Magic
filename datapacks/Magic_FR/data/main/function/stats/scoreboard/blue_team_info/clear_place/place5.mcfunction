...
scoreboard players reset @a[scores={blue_place=5}] blue_place
scoreboard players remove @a[tag=blue_team,scores={blue_place=6..}] blue_place 1
execute as @a[tag=blue_team,scores={blue_place=5..}] run function main:stats/scoreboard/blue_team_info/save_data/check_place
