...
scoreboard players add @a[tag=blue_team,scores={blue_place=6..}] blue_place 1
# décale de 1 les places de tout les joueurs déjà dans placés


scoreboard players set @s blue_place 6

execute as @a[tag=blue_team,scores={blue_place=6..}] run function main:stats/scoreboard/blue_team_info/save_data/check_place
