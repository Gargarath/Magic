...
data modify block 13 97 13 Items[{Slot:11b}].components."minecraft:written_book_content".pages[1].raw.extra append value {nbt:'by_player."11".stat_kd_ratio1',storage:"stats:leaderboards",color:"gold",bold:1b}
...
data modify block 13 97 13 Items[{Slot:11b}].components."minecraft:written_book_content".pages[1].raw.extra append value {nbt:'by_player."11".stat_kd_ratio2',storage:"stats:leaderboards",color:"gold",bold:1b}
