...
execute store result storage temp:sort rank int 1 run scoreboard players get @s sort_final_score
...
function main:stats/leaderboard/sort_stats/sort_final_score/save_place with storage temp:sort
