...
execute store result storage temp:sort rank int 1 run scoreboard players get @s sort_kd_ratio1000
...
function main:stats/leaderboard/sort_stats/sort_kd_ratio1000/save_place with storage temp:sort
