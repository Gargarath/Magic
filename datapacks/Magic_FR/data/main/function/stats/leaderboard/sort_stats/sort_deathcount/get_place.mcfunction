...
execute store result storage temp:sort rank int 1 run scoreboard players get @s sort_deathcount
...
function main:stats/leaderboard/sort_stats/sort_deathcount/save_place with storage temp:sort
