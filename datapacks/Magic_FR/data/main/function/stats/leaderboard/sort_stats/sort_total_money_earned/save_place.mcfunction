...
# score = stat_total_money_earned de @s
$execute store result storage stats:leaderboards by_stat.stat_total_money_earned."$(rank)".score int 1 run scoreboard players get @s stat_total_money_earned