...
execute store result storage temp:sort rank int 1 run scoreboard players get @s sort_dmg_taken
...
function main:stats/leaderboard/sort_stats/sort_dmg_taken/save_place with storage temp:sort
