...
execute as @s[type=text_display,tag=leaderboard1_score] run data merge entity @s {text:[{"bold":true,"color":"yellow","nbt":"by_stat.stat_deathcount.1.score","storage":"stats:leaderboards"},{"bold":false,"color":"white","text":" morts"}]}
...
execute as @s[type=text_display,tag=leaderboard2_score] run data merge entity @s {text:[{"bold":true,"color":"yellow","nbt":"by_stat.stat_deathcount.2.score","storage":"stats:leaderboards"},{"bold":false,"color":"white","text":" morts"}]}
...
execute as @s[type=text_display,tag=leaderboard3_score] run data merge entity @s {text:[{"bold":true,"color":"yellow","nbt":"by_stat.stat_deathcount.3.score","storage":"stats:leaderboards"},{"bold":false,"color":"white","text":" morts"}]}
...
execute as @s[type=text_display,tag=leaderboard4_score] run data merge entity @s {text:[{"bold":true,"color":"yellow","nbt":"by_stat.stat_deathcount.4.score","storage":"stats:leaderboards"},{"bold":false,"color":"white","text":" morts"}]}
...
execute as @s[type=text_display,tag=leaderboard5_score] run data merge entity @s {text:[{"bold":true,"color":"yellow","nbt":"by_stat.stat_deathcount.5.score","storage":"stats:leaderboards"},{"bold":false,"color":"white","text":" morts"}]}
...
execute as @s[type=text_display,tag=leaderboard6_score] run data merge entity @s {text:[{"bold":true,"color":"yellow","nbt":"by_stat.stat_deathcount.6.score","storage":"stats:leaderboards"},{"bold":false,"color":"white","text":" morts"}]}
...
execute as @s[type=text_display,tag=leaderboard7_score] run data merge entity @s {text:[{"bold":true,"color":"yellow","nbt":"by_stat.stat_deathcount.7.score","storage":"stats:leaderboards"},{"bold":false,"color":"white","text":" morts"}]}
...
execute as @s[type=text_display,tag=leaderboard8_score] run data merge entity @s {text:[{"bold":true,"color":"yellow","nbt":"by_stat.stat_deathcount.8.score","storage":"stats:leaderboards"},{"bold":false,"color":"white","text":" morts"}]}
...
execute as @s[type=text_display,tag=leaderboard9_score] run data merge entity @s {text:[{"bold":true,"color":"yellow","nbt":"by_stat.stat_deathcount.9.score","storage":"stats:leaderboards"},{"bold":false,"color":"white","text":" morts"}]}
...
execute as @s[type=text_display,tag=leaderboard10_score] run data merge entity @s {text:[{"bold":true,"color":"yellow","nbt":"by_stat.stat_deathcount.10.score","storage":"stats:leaderboards"},{"bold":false,"color":"white","text":" morts"}]}
...
execute as @s[type=text_display,tag=leaderboard11_score] run data merge entity @s {text:[{"bold":true,"color":"yellow","nbt":"by_stat.stat_deathcount.11.score","storage":"stats:leaderboards"},{"bold":false,"color":"white","text":" morts"}]}
...
execute as @s[type=text_display,tag=leaderboard12_score] run data merge entity @s {text:[{"bold":true,"color":"yellow","nbt":"by_stat.stat_deathcount.12.score","storage":"stats:leaderboards"},{"bold":false,"color":"white","text":" morts"}]}
