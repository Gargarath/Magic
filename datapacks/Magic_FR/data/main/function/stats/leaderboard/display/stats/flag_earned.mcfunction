...
execute if entity @s[tag=leaderboard1] run data merge storage temp:leaderboard_display {stat:"stat_flag_earned",suffix:" drapeaux rapportés",place:1}
...
execute if entity @s[tag=leaderboard2] run data merge storage temp:leaderboard_display {stat:"stat_flag_earned",suffix:" drapeaux rapportés",place:2}
...
execute if entity @s[tag=leaderboard3] run data merge storage temp:leaderboard_display {stat:"stat_flag_earned",suffix:" drapeaux rapportés",place:3}
...
execute if entity @s[tag=leaderboard4] run data merge storage temp:leaderboard_display {stat:"stat_flag_earned",suffix:" drapeaux rapportés",place:4}
...
execute if entity @s[tag=leaderboard5] run data merge storage temp:leaderboard_display {stat:"stat_flag_earned",suffix:" drapeaux rapportés",place:5}
...
execute if entity @s[tag=leaderboard6] run data merge storage temp:leaderboard_display {stat:"stat_flag_earned",suffix:" drapeaux rapportés",place:6}
...
execute if entity @s[tag=leaderboard7] run data merge storage temp:leaderboard_display {stat:"stat_flag_earned",suffix:" drapeaux rapportés",place:7}
...
execute if entity @s[tag=leaderboard8] run data merge storage temp:leaderboard_display {stat:"stat_flag_earned",suffix:" drapeaux rapportés",place:8}
...
execute if entity @s[tag=leaderboard9] run data merge storage temp:leaderboard_display {stat:"stat_flag_earned",suffix:" drapeaux rapportés",place:9}
...
execute if entity @s[tag=leaderboard10] run data merge storage temp:leaderboard_display {stat:"stat_flag_earned",suffix:" drapeaux rapportés",place:10}
...
execute if entity @s[tag=leaderboard11] run data merge storage temp:leaderboard_display {stat:"stat_flag_earned",suffix:" drapeaux rapportés",place:11}
...
execute if entity @s[tag=leaderboard12] run data merge storage temp:leaderboard_display {stat:"stat_flag_earned",suffix:" drapeaux rapportés",place:12}
