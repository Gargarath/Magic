...
$execute if entity @s[tag=leaderboard2] run data modify storage temp:leaderboard_display macro set value {stat:"stat_flag_earned",suffix:" $(tr_stats_flag_earned)",place:2}
...
$execute if entity @s[tag=leaderboard3] run data modify storage temp:leaderboard_display macro set value {stat:"stat_flag_earned",suffix:" $(tr_stats_flag_earned)",place:3}
...
$execute if entity @s[tag=leaderboard4] run data modify storage temp:leaderboard_display macro set value {stat:"stat_flag_earned",suffix:" $(tr_stats_flag_earned)",place:4}
...
$execute if entity @s[tag=leaderboard5] run data modify storage temp:leaderboard_display macro set value {stat:"stat_flag_earned",suffix:" $(tr_stats_flag_earned)",place:5}
...
$execute if entity @s[tag=leaderboard6] run data modify storage temp:leaderboard_display macro set value {stat:"stat_flag_earned",suffix:" $(tr_stats_flag_earned)",place:6}
...
$execute if entity @s[tag=leaderboard7] run data modify storage temp:leaderboard_display macro set value {stat:"stat_flag_earned",suffix:" $(tr_stats_flag_earned)",place:7}
...
$execute if entity @s[tag=leaderboard8] run data modify storage temp:leaderboard_display macro set value {stat:"stat_flag_earned",suffix:" $(tr_stats_flag_earned)",place:8}
...
$execute if entity @s[tag=leaderboard9] run data modify storage temp:leaderboard_display macro set value {stat:"stat_flag_earned",suffix:" $(tr_stats_flag_earned)",place:9}
...
$execute if entity @s[tag=leaderboard10] run data modify storage temp:leaderboard_display macro set value {stat:"stat_flag_earned",suffix:" $(tr_stats_flag_earned)",place:10}
...
$execute if entity @s[tag=leaderboard11] run data modify storage temp:leaderboard_display macro set value {stat:"stat_flag_earned",suffix:" $(tr_stats_flag_earned)",place:11}
...
$execute if entity @s[tag=leaderboard12] run data modify storage temp:leaderboard_display macro set value {stat:"stat_flag_earned",suffix:" $(tr_stats_flag_earned)",place:12}
