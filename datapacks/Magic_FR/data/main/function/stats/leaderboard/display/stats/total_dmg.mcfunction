...
$execute if entity @s[tag=leaderboard1] run data modify storage temp:leaderboard_display macro set value {stat:"stat_total_dmg",suffix:" $(tr_stats_total_dmg)",place:1}
...
$execute if entity @s[tag=leaderboard2] run data modify storage temp:leaderboard_display macro set value {stat:"stat_total_dmg",suffix:" $(tr_stats_total_dmg)",place:2}
...
$execute if entity @s[tag=leaderboard3] run data modify storage temp:leaderboard_display macro set value {stat:"stat_total_dmg",suffix:" $(tr_stats_total_dmg)",place:3}
...
$execute if entity @s[tag=leaderboard4] run data modify storage temp:leaderboard_display macro set value {stat:"stat_total_dmg",suffix:" $(tr_stats_total_dmg)",place:4}
...
$execute if entity @s[tag=leaderboard5] run data modify storage temp:leaderboard_display macro set value {stat:"stat_total_dmg",suffix:" $(tr_stats_total_dmg)",place:5}
...
$execute if entity @s[tag=leaderboard6] run data modify storage temp:leaderboard_display macro set value {stat:"stat_total_dmg",suffix:" $(tr_stats_total_dmg)",place:6}
...
$execute if entity @s[tag=leaderboard7] run data modify storage temp:leaderboard_display macro set value {stat:"stat_total_dmg",suffix:" $(tr_stats_total_dmg)",place:7}
...
$execute if entity @s[tag=leaderboard8] run data modify storage temp:leaderboard_display macro set value {stat:"stat_total_dmg",suffix:" $(tr_stats_total_dmg)",place:8}
...
$execute if entity @s[tag=leaderboard9] run data modify storage temp:leaderboard_display macro set value {stat:"stat_total_dmg",suffix:" $(tr_stats_total_dmg)",place:9}
...
$execute if entity @s[tag=leaderboard10] run data modify storage temp:leaderboard_display macro set value {stat:"stat_total_dmg",suffix:" $(tr_stats_total_dmg)",place:10}
...
$execute if entity @s[tag=leaderboard11] run data modify storage temp:leaderboard_display macro set value {stat:"stat_total_dmg",suffix:" $(tr_stats_total_dmg)",place:11}
...
$execute if entity @s[tag=leaderboard12] run data modify storage temp:leaderboard_display macro set value {stat:"stat_total_dmg",suffix:" $(tr_stats_total_dmg)",place:12}
