...
execute as @a[scores={Player=1..}] run function main:launch_arena/setspawn_and_tp/graveyard
# met les spawns et tp les joueurs

clone 19 95 17 21 96 19 250 169 -240
# place les blocs invisibles bleus
clone 19 95 17 21 96 19 184 169 -324
...
summon armor_stand 177 166.5 -286 {NoGravity:1b,Invulnerable:1b,Small:1b,Invisible:1b,PersistenceRequired:1b,Tags:["Spot_Red_flag"],DisabledSlots:4144959}
summon armor_stand 259 166.5 -276 {NoGravity:1b,Invulnerable:1b,Small:1b,Invisible:1b,PersistenceRequired:1b,Tags:["Spot_Blue_flag"],DisabledSlots:4144959}
