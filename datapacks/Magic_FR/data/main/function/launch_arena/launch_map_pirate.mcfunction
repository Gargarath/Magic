...
execute if score $gamemode option_panel matches 0 run function main:launch_arena/respawn_makers/pirate
# setup les marker de respawn si on est en mode FFA
execute if score shop enable_loop matches 0 run execute as @a[scores={Player=1..}] run function main:launch_arena/setspawn_and_tp/pirate
...
execute if score $gamemode option_panel matches 1 run execute if score $gamemode option_panel matches 1 run function main:launch_arena/reset_flags
