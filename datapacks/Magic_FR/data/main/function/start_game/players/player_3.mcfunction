# Fonction appellée par main:start_game/start_game permet de deffinir @s comme le joueur 3 de le tp dans la frameroom n°3
scoreboard players set @s Player 3
execute at @e[tag=room3] run tp @s ~ ~9 ~ 0 -5
execute at @e[tag=room3] run spawnpoint @s ~ ~9 ~
