# Fonction appellée par main:start_game/start_game permet de deffinir @s comme le joueur 6 de le tp dans la frameroom n°6
scoreboard players set @s Player 6
execute at @e[tag=room6] run tp @s ~ ~9 ~ 0 -5
execute at @e[tag=room6] run spawnpoint @s ~ ~9 ~
