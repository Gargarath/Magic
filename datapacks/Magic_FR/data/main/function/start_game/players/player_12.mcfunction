# Fonction appellée par main:start_game/start_game permet de deffinir @s comme le joueur 12 de le tp dans la frameroom n°12
scoreboard players set @s Player 12
execute at @e[tag=room12] run tp @s ~ ~9 ~ 0 -5
execute at @e[tag=room12] run spawnpoint @s ~ ~9 ~
