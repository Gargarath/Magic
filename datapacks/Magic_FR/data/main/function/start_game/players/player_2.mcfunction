# Fonction appellée par main:start_game/start_game permet de deffinir @s comme le joueur 2 de le tp dans la frameroom n°2
scoreboard players set @s Player 2
execute at @e[tag=room2] run tp @s ~ ~9 ~ 0 -5
execute at @e[tag=room2] run spawnpoint @s ~ ~9 ~
