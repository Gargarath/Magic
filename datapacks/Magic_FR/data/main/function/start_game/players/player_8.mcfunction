# Fonction appellée par main:start_game/start_game permet de deffinir @s comme le joueur 8 de le tp dans la frameroom n°8
scoreboard players set @s Player 8
execute at @e[tag=room8] run tp @s ~ ~9 ~ 0 -5
execute at @e[tag=room8] run spawnpoint @s ~ ~9 ~
