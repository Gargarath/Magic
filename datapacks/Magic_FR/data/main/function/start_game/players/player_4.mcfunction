# Fonction appellée par main:start_game/start_game permet de deffinir @s comme le joueur 4 de le tp dans la frameroom n°4
scoreboard players set @s Player 4
execute at @e[tag=room4] run tp @s ~ ~9 ~ 0 -5
execute at @e[tag=room4] run spawnpoint @s ~ ~9 ~
