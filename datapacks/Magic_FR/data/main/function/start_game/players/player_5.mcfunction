# Fonction appellée par main:start_game/start_game permet de deffinir @s comme le joueur 5 de le tp dans la frameroom n°5
scoreboard players set @s Player 5
execute at @e[tag=room5] run tp @s ~ ~9 ~ 0 -5
execute at @e[tag=room5] run spawnpoint @s ~ ~9 ~
