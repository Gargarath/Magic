# Fonction appellée par main:start_game/start_game permet de deffinir @s comme le joueur 7 de le tp dans la frameroom n°7
scoreboard players set @s Player 7
execute at @e[tag=room7] run tp @s ~ ~9 ~ 0 -5
execute at @e[tag=room7] run spawnpoint @s ~ ~9 ~
