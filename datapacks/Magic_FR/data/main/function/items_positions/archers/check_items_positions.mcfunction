## appelée par item_save_system si @s est un archer permet de sauvegarder l'équipement de @s

scoreboard players operation @s weapon1_slot2 = @s weapon1_slot_a
scoreboard players operation @s spell1_slot2 = @s spell1_slot_a
scoreboard players operation @s spell2_slot2 = @s spell2_slot_a
scoreboard players operation @s spell3_slot2 = @s spell3_slot_a
scoreboard players operation @s arrows_slot2 = @s arrows_slot
scoreboard players operation @s quit_slot2 = @s quit_slot_a
...
execute if data entity @s Inventory[{components:{"minecraft:custom_data":{arrows_slot:1b}}}] store result score @s arrows_slot2 run data get entity @s Inventory[{components:{"minecraft:custom_data":{arrows_slot:1b}}}].Slot
...
execute if score @s item_save_error matches 0 run function main:items_positions/archers/save_item_positions