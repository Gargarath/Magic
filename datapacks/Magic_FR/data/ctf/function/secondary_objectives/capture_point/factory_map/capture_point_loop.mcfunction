...
# bleus
execute unless score state point_capture matches 1 as @a[x=317.5,y=148,z=4.5,dx=7.1,dy=3,dz=7.1,team=blue,scores={trapped=-1}] unless entity @a[x=317.5,y=148,z=4.5,dx=7.1,dy=3,dz=7.1,team=red,scores={trapped=-1}] run function ctf:secondary_objectives/capture_point/point_state_0/blue_cap
...
execute unless score state point_capture matches 1 if score capture_blue point_capture matches 1.. unless entity @a[x=317.5,y=148,z=4.5,dx=7.1,dy=3,dz=7.1,team=blue,scores={trapped=-1}] run function ctf:secondary_objectives/capture_point/point_state_0/no_more_blue_on_point
...
# rouges
execute unless score state point_capture matches 2 as @a[x=317.5,y=148,z=4.5,dx=7.1,dy=3,dz=7.1,team=red,scores={trapped=-1}] unless entity @a[x=317.5,y=148,z=4.5,dx=7.1,dy=3,dz=7.1,team=blue,scores={trapped=-1}] run function ctf:secondary_objectives/capture_point/point_state_0/red_cap
...
execute unless score state point_capture matches 2 if score capture_red point_capture matches 1.. unless entity @a[x=317.5,y=148,z=4.5,dx=7.1,dy=3,dz=7.1,team=red,scores={trapped=-1}] run function ctf:secondary_objectives/capture_point/point_state_0/no_more_red_on_point
...
execute if score state point_capture matches 1 as @a[x=317.5,y=148,z=4.5,dx=7.1,dy=3,dz=7.1,scores={trapped=-1},team=blue] unless entity @a[x=317.5,y=148,z=4.5,dx=7.1,dy=3,dz=7.1,scores={trapped=-1},team=red] run function ctf:secondary_objectives/capture_point/point_state_1/blue_cap_point
...
execute if score state point_capture matches 2 as @a[x=317.5,y=148,z=4.5,dx=7.1,dy=3,dz=7.1,scores={trapped=-1},team=red] unless entity @a[x=317.5,y=148,z=4.5,dx=7.1,dy=3,dz=7.1,scores={trapped=-1},team=blue] run function ctf:secondary_objectives/capture_point/point_state_2/red_cap_point
