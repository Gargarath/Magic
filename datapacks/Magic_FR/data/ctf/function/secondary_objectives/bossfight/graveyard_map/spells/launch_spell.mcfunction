...
execute if entity @a[tag=target,tag=targetable] if score selected_spell lich matches 1 run function ctf:secondary_objectives/bossfight/graveyard_map/spells/spell1/cast_spell1
execute if entity @a[tag=target,tag=targetable] if score selected_spell lich matches 2 run function ctf:secondary_objectives/bossfight/graveyard_map/spells/spell2/cast_spell2
execute if entity @a[tag=target,tag=targetable] if score selected_spell lich matches 3 run function ctf:secondary_objectives/bossfight/graveyard_map/spells/spell3/cast_spell3
