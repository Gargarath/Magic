## appelée par death_trail_hit si @s a prit un darkness_trail de la liche
...
# change la cause de la mort de @s dans son storage par la texture du kill du darkness_trail
