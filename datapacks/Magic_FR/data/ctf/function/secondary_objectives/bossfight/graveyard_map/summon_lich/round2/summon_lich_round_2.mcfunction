...
execute if score min_players lich matches 1 run bossbar set minecraft:secondary_objective max 125
...
execute if score min_players lich matches 2 run bossbar set minecraft:secondary_objective max 250
...
execute if score min_players lich matches 3 run bossbar set minecraft:secondary_objective max 375
...
execute if score min_players lich matches 4 run bossbar set minecraft:secondary_objective max 500
...
execute if score min_players lich matches 5 run bossbar set minecraft:secondary_objective max 625
...
execute if score min_players lich matches 6.. run bossbar set minecraft:secondary_objective max 750
