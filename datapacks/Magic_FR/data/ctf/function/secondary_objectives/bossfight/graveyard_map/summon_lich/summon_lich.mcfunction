...
data modify storage main:killfeed bossname set value {"bold":false,"color":"gray","text":"Liche"}
...
execute if score round bossbar matches 1 run function ctf:secondary_objectives/bossfight/graveyard_map/summon_lich/round1/summon_lich_round_1
execute if score round bossbar matches 2 run function ctf:secondary_objectives/bossfight/graveyard_map/summon_lich/round2/summon_lich_round_2
execute if score round bossbar matches 3 run function ctf:secondary_objectives/bossfight/graveyard_map/summon_lich/round3/summon_lich_round_3
