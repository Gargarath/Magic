...
execute if score round bossbar matches 1 run function ctf:secondary_objectives/bossfight/ruin_map/summon_golem/round1/summon_golem_round_1
execute if score round bossbar matches 2 run function ctf:secondary_objectives/bossfight/ruin_map/summon_golem/round2/summon_golem_round_2
execute if score round bossbar matches 3 run function ctf:secondary_objectives/bossfight/ruin_map/summon_golem/round3/summon_golem_round_3
