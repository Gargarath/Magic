...
execute if score @s team_side matches 1 run function ctf:secondary_objectives/bossfight/ruin_map/win/blue_win
execute if score @s team_side matches 2 run function ctf:secondary_objectives/bossfight/ruin_map/win/red_win
