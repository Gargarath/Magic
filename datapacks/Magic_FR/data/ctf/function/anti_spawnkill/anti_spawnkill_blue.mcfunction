...
execute if entity @s[tag=!in_own_spawn] if block ~ ~-45 ~ #blue_spawn run function ctf:anti_spawnkill/spawn/enter_own_spawn
execute if entity @s[tag=in_own_spawn] at @s unless block ~ ~-45 ~ #blue_spawn run function ctf:anti_spawnkill/spawn/leave_own_spawn
