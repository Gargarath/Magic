...
execute if score $teamkill option_panel matches 1 if score red playercount matches 3.. run execute unless entity @a[team=red] run function ctf:respawns/bossbar/teamkill/teamkill_red
