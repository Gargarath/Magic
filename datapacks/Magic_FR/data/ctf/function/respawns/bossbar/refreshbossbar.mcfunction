...
execute if score @s Player matches 1 run function ctf:respawns/bossbar/refreshbossbar/refreshbossbar_player1
# si le joueur 1 est en attente de respawn alors on actualise sa bossbar.
execute if score @s Player matches 2 run function ctf:respawns/bossbar/refreshbossbar/refreshbossbar_player2
# si le joueur 2 est en attente de respawn alors on actualise sa bossbar.
execute if score @s Player matches 3 run function ctf:respawns/bossbar/refreshbossbar/refreshbossbar_player3
# si le joueur 3 est en attente de respawn alors on actualise sa bossbar.
execute if score @s Player matches 4 run function ctf:respawns/bossbar/refreshbossbar/refreshbossbar_player4
# si le joueur 4 est en attente de respawn alors on actualise sa bossbar.
execute if score @s Player matches 5 run function ctf:respawns/bossbar/refreshbossbar/refreshbossbar_player5
# si le joueur 5 est en attente de respawn alors on actualise sa bossbar.
execute if score @s Player matches 6 run function ctf:respawns/bossbar/refreshbossbar/refreshbossbar_player6
# si le joueur 6 est en attente de respawn alors on actualise sa bossbar.
execute if score @s Player matches 7 run function ctf:respawns/bossbar/refreshbossbar/refreshbossbar_player7
# si le joueur 7 est en attente de respawn alors on actualise sa bossbar.
execute if score @s Player matches 8 run function ctf:respawns/bossbar/refreshbossbar/refreshbossbar_player8
# si le joueur 8 est en attente de respawn alors on actualise sa bossbar.
execute if score @s Player matches 9 run function ctf:respawns/bossbar/refreshbossbar/refreshbossbar_player9
# si le joueur 9 est en attente de respawn alors on actualise sa bossbar.
execute if score @s Player matches 10 run function ctf:respawns/bossbar/refreshbossbar/refreshbossbar_player10
# si le joueur 10 est en attente de respawn alors on actualise sa bossbar.
execute if score @s Player matches 11 run function ctf:respawns/bossbar/refreshbossbar/refreshbossbar_player11
# si le joueur 11 est en attente de respawn alors on actualise sa bossbar.
execute if score @s Player matches 12 run function ctf:respawns/bossbar/refreshbossbar/refreshbossbar_player12
...
execute as @s if score @s respawn_time = @s max_respawn_bar run function ctf:respawns/no_more_respawn_time
