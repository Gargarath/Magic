...
execute if score round bossbar matches 4 run return run function ctf:timer/timer_actualise/red

# 2m50-5m -> rend le texte vert

execute if score $minutes timers matches 3.. run return run function ctf:timer/timer_actualise/green
execute if score $minutes timers matches 2 if score $seconds timers matches 30.. run return run function ctf:timer/timer_actualise/green


# 1m-2m29 -> rend le texte jaune
execute if score $minutes timers matches 1 run return run function ctf:timer/timer_actualise/yellow
execute if score $minutes timers matches 2 if score $seconds timers matches ..29 run return run function ctf:timer/timer_actualise/yellow


# >1m -> rend le texte rouge
execute if score $minutes timers matches 0 run return run function ctf:timer/timer_actualise/red
