...
execute if score $secondary_objectives option_panel matches 1 if score on secnd_objective matches 0 run function ctf:timer/objective_decount_timer
# si les objectifs secondaires sont activé et que l'objectif secondaire ne s'est pas encore déclanché -> continue le décompte

function ctf:timer/timer_actualise/timer_actualise
# actualise le timer
