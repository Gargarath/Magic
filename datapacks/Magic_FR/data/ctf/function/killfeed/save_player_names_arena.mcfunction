...
data modify storage ctf:killfeed name.10 set from block 14 97 13 front_text.messages[0]
...
data modify storage ctf:killfeed name.11 set from block 14 97 13 front_text.messages[0]
...
data modify storage ctf:killfeed name.12 set from block 14 97 13 front_text.messages[0]
