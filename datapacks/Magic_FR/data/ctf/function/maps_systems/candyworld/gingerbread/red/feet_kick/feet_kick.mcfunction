...
clone -15 141 -774 -22 150 -781 7 177 -777
# tete devient enervé
clone 3 152 -768 -4 145 -775 9 160 -773
# lève le pied
playsound minecraft:entity.generic.explode master @a 10.00 160.00 -767.04 1 0 0
execute at @s run particle minecraft:explosion ~ ~1 ~ 1 0 1 0 3
summon falling_block 10.1 160 -767.9 {BlockState:{Name:"minecraft:furnace"},Time:1,DropItem:0b,HurtEntities:0b,Motion:[-1.65,1.7,1.14],Tags:["gingerbread_motion","gingerbread_motion_red"]}
