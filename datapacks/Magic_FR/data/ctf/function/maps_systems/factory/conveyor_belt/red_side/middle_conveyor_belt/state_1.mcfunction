...
execute as @a[gamemode=adventure,tag=conveyor_belt_red_middle,scores={conveyor_belt=2..},x=332.9,y=155.3,z=-18.9,dx=0.5,dy=0.6,dz=53.5] at @s run function ctf:maps_systems/factory/conveyor_belt/red_side/middle_conveyor_belt/move_state_1
