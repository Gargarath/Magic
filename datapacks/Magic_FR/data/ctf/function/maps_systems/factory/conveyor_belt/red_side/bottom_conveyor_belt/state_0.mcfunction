...
execute as @a[tag=conveyor_belt_red_bottom,scores={conveyor_belt=2..},x=282.0,y=152.3,z=17.9,dx=79,dy=0.6,dz=0.5] at @s run function ctf:maps_systems/factory/conveyor_belt/red_side/bottom_conveyor_belt/move_state_0
