...
# permet de faire bouger les tapis roulant du haut dans le sens classique
        ...
        # JOUEURS
execute as @a[gamemode=adventure,scores={trapped=-1,hooked_w=-1},x=292.0,y=158.3,z=27.9,dx=48,dy=0.6,dz=0.5,tag=!conveyor_belt_red_top] if data entity @s {OnGround:1b} run function ctf:maps_systems/factory/conveyor_belt/red_side/top_conveyor_belt/joined_conveyor
execute as @a[gamemode=adventure,scores={trapped=-1,hooked_w=-1},tag=conveyor_belt_red_top] unless entity @s[x=292.0,y=158.3,z=27.9,dx=48,dy=0.6,dz=0.5] run function ctf:maps_systems/factory/conveyor_belt/red_side/top_conveyor_belt/left_conveyor
...
execute as @a[gamemode=adventure,tag=conveyor_belt_red_top,scores={conveyor_belt=2..},x=292.0,y=158.3,z=27.9,dx=48,dy=0.6,dz=0.5] at @s run function ctf:maps_systems/factory/conveyor_belt/red_side/top_conveyor_belt/move_state_0
