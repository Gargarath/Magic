...
execute if score $secondary_objectives option_panel matches 1 if score on lich matches 1 run function ctf:secondary_objectives/bossfight/graveyard_map/bossfight_loop

## LEVIER
execute if score red lever_graveyard matches 1 if block 190 169 -294 minecraft:lever[powered=false] run function ctf:maps_systems/graveyard/leversystem/red_lever_up
...
execute if score red lever_graveyard matches 0 if block 190 169 -294 minecraft:lever[powered=true] run function ctf:maps_systems/graveyard/leversystem/red_lever_down
...
execute if score blue lever_graveyard matches 1 if block 246 169 -268 minecraft:lever[powered=false] run function ctf:maps_systems/graveyard/leversystem/blue_lever_up
...
execute if score blue lever_graveyard matches 0 if block 246 169 -268 minecraft:lever[powered=true] run function ctf:maps_systems/graveyard/leversystem/blue_lever_down
...
execute as @a[scores={Player=1..},tag=!in_bad_path] at @s if block ~ ~-70 ~ minecraft:red_concrete run function ctf:maps_systems/graveyard/graveyard_path_abuse/enter_bad_path
