...
execute as @s[tag=bad_path_with_flag_blue] run function ctf:dropflag/flag_in_water_blueflag
execute as @s[tag=bad_path_with_flag_red] run function ctf:dropflag/flag_in_water_redflag
