...
execute if score @s[scores={Player=9},team=blue] cap_flag_time matches 1 run bossbar set capflag:player9 name ["",{"text":"Capture :","bold":true,"color":"red"}]
execute if score @s[scores={Player=9},team=red] cap_flag_time matches 1 run bossbar set capflag:player9 color blue
execute if score @s[scores={Player=9},team=red] cap_flag_time matches 1 run bossbar set capflag:player9 name ["",{"text":"Capture :","bold":true,"color":"blue"}]
