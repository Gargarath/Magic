...
execute if score $no_cooldowns option_panel matches 0 run execute as @s[scores={spell1=1}] run function stuff:stuff_warrior/cooldowns_w/spell1/spell1lvl1_w
execute if score $no_cooldowns option_panel matches 0 run execute as @s[scores={spell1=2}] run function stuff:stuff_warrior/cooldowns_w/spell1/spell1lvl2_w
execute if score $no_cooldowns option_panel matches 0 run execute as @s[scores={spell1=3}] run function stuff:stuff_warrior/cooldowns_w/spell1/spell1lvl3_w
