...
execute as @e[type=marker,tag=exploraycast9] at @s positioned 0 0 0 rotated as @e[type=marker,tag=exploarrow_rotation9,limit=1,distance=..2] run rotate @s ~ 0
data merge entity @s[type=arrow] {CustomName:"2"}
execute if entity @s[type=!arrow] run data merge entity @e[type=text_display,tag=explo_player_timer9,limit=1] {text:"2"}
...
execute at @s as @e[type=marker,tag=exploraycast9_1,limit=1,sort=nearest] at @s rotated ~-20 0 positioned ^0.5 ^ ^-0.5 positioned ~ ~ ~ run function spells:spellsystem/spell1/spell1_a/raycast/player9/yellow
execute at @s as @e[type=marker,tag=exploraycast9_2,limit=1,sort=nearest] at @s rotated ~20 0 positioned ^-0.5 ^ ^-0.5 positioned ~ ~ ~ run function spells:spellsystem/spell1/spell1_a/raycast/player9/yellow