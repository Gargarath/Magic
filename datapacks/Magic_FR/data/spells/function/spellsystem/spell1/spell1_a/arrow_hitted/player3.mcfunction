...
execute as @e[type=#spellable,tag=!spell_immune,tag=in_explo3,scores={last_caster=0}] run function spells:spellsystem/spell1/spell1_a/took_spell1_a
# indique que @s est touché par la flèche explo (pour le kill feed)

scoreboard players set @e[type=#spellable,tag=!spell_immune,tag=in_explo3,scores={last_caster=0}] last_caster 3
# tag pour check après 1 tick les pv des joueurs ou du boss - le tag dépend du numéro de joueur du caster


execute at @e[type=#spellable,tag=!spell_immune,tag=in_explo3] run playsound minecraft:entity.arrow.hit_player master @a[scores={Player=3}] ~ ~ ~ 100 0
...
execute if score @a[scores={Player=3},limit=1] spell1 matches 1 as @a[tag=in_explo3] if entity @s[tag=no_team] at @e[type=marker,tag=exploraycast3_1,limit=1] run function spells:spellsystem/spell1/spell1_a/apply_dmg/apply_dmg_lvl1
...
execute if score @a[scores={Player=3},limit=1] spell1 matches 2 as @a[tag=in_explo3] if entity @s[tag=no_team] at @e[type=marker,tag=exploraycast3_1,limit=1] run function spells:spellsystem/spell1/spell1_a/apply_dmg/apply_dmg_lvl2
...
execute if score @a[scores={Player=3},limit=1] spell1 matches 3 as @a[tag=in_explo3] if entity @s[tag=no_team] at @e[type=marker,tag=exploraycast3_1,limit=1] run function spells:spellsystem/spell1/spell1_a/apply_dmg/apply_dmg_lvl3
...
tag @e[type=#spellable,tag=!spell_immune,tag=in_explo3] remove in_explo3
