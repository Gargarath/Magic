...
execute if score @a[scores={Player=7},limit=1] spell1 matches 1 if entity @e[type=#spellable,distance=..10] as @e[type=marker,tag=exploraycast7] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player7/dark_red
execute if score @a[scores={Player=7},limit=1] spell1 matches 2 if entity @e[type=#spellable,distance=..12] as @e[type=marker,tag=exploraycast7] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player7/dark_red
execute if score @a[scores={Player=7},limit=1] spell1 matches 3 if entity @e[type=#spellable,distance=..15] as @e[type=marker,tag=exploraycast7] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player7/dark_red
