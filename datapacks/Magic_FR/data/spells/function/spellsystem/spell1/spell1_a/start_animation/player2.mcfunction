...
execute at @s as @e[type=marker,tag=exploraycast2_1,limit=1,sort=nearest] at @s positioned ~ ~ ~ rotated ~-20 0 positioned ^0.5 ^ ^-0.5 run function spells:spellsystem/spell1/spell1_a/raycast/player2/green
execute at @s as @e[type=marker,tag=exploraycast2_2,limit=1,sort=nearest] at @s positioned ~ ~ ~ rotated ~20 0 positioned ^-0.5 ^ ^-0.5 run function spells:spellsystem/spell1/spell1_a/raycast/player2/green
