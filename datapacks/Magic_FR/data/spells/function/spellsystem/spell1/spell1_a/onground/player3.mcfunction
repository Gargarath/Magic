...
execute positioned 0 0 0 run scoreboard players operation @s[type=arrow] spell1_a_direction = @e[type=marker,tag=exploarrow_rotation3,limit=1,distance=..2] spell1_a_direction
