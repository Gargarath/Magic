...
execute as @e[type=#spellable,distance=..0.35,team=!spectator] run tag @s add in_explo12
execute positioned ~ ~-1.5 ~ as @e[type=#spellable,distance=..0.35,team=!spectator] run tag @s add in_explo12
