...
execute if score @a[scores={Player=3},limit=1] spell1 matches 1 if entity @a[scores={Player=3..},distance=..10] as @e[type=marker,tag=exploraycast3] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player3/dark_red
execute if score @a[scores={Player=3},limit=1] spell1 matches 2 if entity @a[scores={Player=3..},distance=..12] as @e[type=marker,tag=exploraycast3] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player3/dark_red
execute if score @a[scores={Player=3},limit=1] spell1 matches 3 if entity @a[scores={Player=3..},distance=..15] as @e[type=marker,tag=exploraycast3] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player3/dark_red
