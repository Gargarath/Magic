...
execute if entity @s[type=!arrow] run data merge entity @e[type=text_display,tag=explo_player_timer4,limit=1] {text:"1"}
...
execute at @s as @e[type=marker,tag=exploraycast4_1,limit=1,sort=nearest] at @s rotated ~-20 0 positioned ^0.5 ^ ^-0.5 positioned ~ ~ ~ run function spells:spellsystem/spell1/spell1_a/raycast/player4/red
execute at @s as @e[type=marker,tag=exploraycast4_2,limit=1,sort=nearest] at @s rotated ~20 0 positioned ^-0.5 ^ ^-0.5 positioned ~ ~ ~ run function spells:spellsystem/spell1/spell1_a/raycast/player4/red