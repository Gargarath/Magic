...
execute if score @a[scores={Player=2},limit=1] spell1 matches 1 as @e[type=#spellable,distance=..10] at @s run function spells:spellsystem/spell1/spell1_a/detonate/summon_markers {id:2}
execute if score @a[scores={Player=2},limit=1] spell1 matches 2 as @e[type=#spellable,distance=..12] at @s run function spells:spellsystem/spell1/spell1_a/detonate/summon_markers {id:2}
execute if score @a[scores={Player=2},limit=1] spell1 matches 3 as @e[type=#spellable,distance=..15] at @s run function spells:spellsystem/spell1/spell1_a/detonate/summon_markers {id:2}
...
scoreboard players operation @e[type=#spellable,tag=in_explo2,scores={last_caster=0}] hit_by_explo_charge = @s arrow_charge
execute if entity @s[tag=freeze_arrow] as @e[type=#spellable,tag=in_explo2] run function spells:spellsystem/spell3/spell3_a/get_frozen/player2/test_lvl
