...
execute if score @a[scores={Player=5},limit=1] spell1 matches 1 as @e[type=#spellable,distance=..10] at @s run function spells:spellsystem/spell1/spell1_a/detonate/summon_markers {id:5}
execute if score @a[scores={Player=5},limit=1] spell1 matches 2 as @e[type=#spellable,distance=..12] at @s run function spells:spellsystem/spell1/spell1_a/detonate/summon_markers {id:5}
execute if score @a[scores={Player=5},limit=1] spell1 matches 3 as @e[type=#spellable,distance=..15] at @s run function spells:spellsystem/spell1/spell1_a/detonate/summon_markers {id:5}
...
execute if score @a[scores={Player=5},limit=1] spell1 matches 1 if entity @a[scores={Player=5..},distance=..10] as @e[type=marker,tag=exploraycast5] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player5/dark_red
execute if score @a[scores={Player=5},limit=1] spell1 matches 2 if entity @a[scores={Player=5..},distance=..12] as @e[type=marker,tag=exploraycast5] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player5/dark_red
execute if score @a[scores={Player=5},limit=1] spell1 matches 3 if entity @a[scores={Player=5..},distance=..15] as @e[type=marker,tag=exploraycast5] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player5/dark_red
...
scoreboard players operation @e[type=#spellable,tag=in_explo5,scores={last_caster=0}] hit_by_explo_charge = @s arrow_charge
execute if entity @s[tag=freeze_arrow] as @e[type=#spellable,tag=in_explo5] run function spells:spellsystem/spell3/spell3_a/get_frozen/player5/test_lvl
