...
execute positioned 0 0 0 run scoreboard players operation @e[type=#spellable,tag=in_explo10,scores={last_caster=0}] hit_by_explo_charge = @e[type=marker,tag=exploarrow_rotation10,limit=1,distance=..2] arrow_charge
...
execute positioned 0 0 0 if entity @e[tag=exploarrow_rotation10,tag=explosive_freeze_arrow,distance=..2,limit=1] as @e[type=#spellable,tag=in_explo10] run function spells:spellsystem/spell3/spell3_a/get_frozen/player10/test_lvl
...
execute if score @a[scores={Player=10},limit=1] spell1 matches 1 as @e[type=#boss,tag=in_explo10] at @e[type=marker,tag=exploraycast10_1,limit=1] run function spells:spellsystem/spell1/spell1_a/apply_dmg/apply_dmg_lvl1
execute if score @a[scores={Player=10},limit=1] spell1 matches 2 as @e[type=#boss,tag=in_explo10] at @e[type=marker,tag=exploraycast10_1,limit=1] run function spells:spellsystem/spell1/spell1_a/apply_dmg/apply_dmg_lvl2
execute if score @a[scores={Player=10},limit=1] spell1 matches 3 as @e[type=#boss,tag=in_explo10] at @e[type=marker,tag=exploraycast10_1,limit=1] run function spells:spellsystem/spell1/spell1_a/apply_dmg/apply_dmg_lvl3
# inflige les dégats au nom de @s (mob qui subit des dmgs)

tag @e[type=#spellable,tag=in_explo10] remove in_explo10
execute positioned 0 0 0 run kill @e[tag=exploarrow_rotation10,distance=..2]
