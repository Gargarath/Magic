...
execute positioned 0 0 0 run scoreboard players operation @e[type=#spellable,tag=in_explo2,scores={last_caster=0}] hit_by_explo_charge = @e[type=marker,tag=exploarrow_rotation2,limit=1,distance=..2] arrow_charge
...
execute positioned 0 0 0 if entity @e[tag=exploarrow_rotation2,tag=explosive_freeze_arrow,distance=..2,limit=1] as @e[type=#spellable,tag=in_explo2] run function spells:spellsystem/spell3/spell3_a/get_frozen/player2/test_lvl
...
execute positioned 0 0 0 run kill @e[tag=exploarrow_rotation2,distance=..2]
