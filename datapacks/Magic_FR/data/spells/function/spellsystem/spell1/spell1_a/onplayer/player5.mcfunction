...
execute positioned 0 0 0 as @e[type=marker,tag=exploarrow_rotation5,limit=1,distance=..2] if score @s spell1_a_direction matches 1 at @s run rotate @s ~ 0
execute positioned 0 0 0 as @e[type=marker,tag=exploarrow_rotation5,limit=1,distance=..2] if score @s spell1_a_direction matches 2 at @s run rotate @s ~90 0
execute positioned 0 0 0 as @e[type=marker,tag=exploarrow_rotation5,limit=1,distance=..2] if score @s spell1_a_direction matches 3 at @s run rotate @s ~180 0
execute positioned 0 0 0 as @e[type=marker,tag=exploarrow_rotation5,limit=1,distance=..2] if score @s spell1_a_direction matches 4 at @s run rotate @s ~-90 0
execute positioned 0 0 0 as @e[type=marker,tag=exploarrow_rotation5,limit=1,distance=..2] run scoreboard players set @s spell1_a_direction -1

#execute positioned 0 0 0 run scoreboard players operation @s hit_by_explo_charge = @e[type=minecraft:marker,tag=exploarrow_rotation5,distance=..2] hit_by_explo_charge

execute if entity @s[type=!iron_golem,type=!slime] run summon text_display ~ ~2 ~ {billboard:"center",Tags:["explo_player_timer","explo_player_timer5"],text:"3"}
execute if entity @s[type=!player,type=!wither_skeleton] run summon text_display ~ ~3 ~ {billboard:"center",Tags:["explo_player_timer","explo_player_timer5"],text:"3"}
...
scoreboard players set @s hit_by_explo 5
function spells:spellsystem/spell1/spell1_a/start_animation/player5