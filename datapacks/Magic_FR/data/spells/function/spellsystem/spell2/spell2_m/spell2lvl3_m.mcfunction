...
execute if block ~ ~ ~ #spell_beam unless block ~ ~-45 ~ #spawn_protectors positioned ~ ~-1 ~ unless entity @e[type=#minecraft:spellable,distance=..0.9,tag=!spell_immune] positioned ~ ~1 ~ positioned ^ ^ ^1 if block ~ ~ ~ #spell_beam run function spells:spellsystem/spell2/spell2_m/spell2lvl3_m
