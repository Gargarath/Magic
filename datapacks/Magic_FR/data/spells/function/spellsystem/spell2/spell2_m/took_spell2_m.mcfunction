## appelée par spell2_m/casted_by/playerX si @s a prit un éclair de la tempête de foudre
...
# change la cause de la mort de @s dans son storage par la texture du kill de la tempête de foudre
