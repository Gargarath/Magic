...
execute if score $no_cooldowns option_panel matches 0 if score @s spell2 matches 1 run function stuff:stuff_mage/cooldowns_m/spell2/spell2lvl1_m with entity @s EnderItems[0].components.minecraft:custom_data
...
execute if score $no_cooldowns option_panel matches 0 if score @s spell2 matches 2 run function stuff:stuff_mage/cooldowns_m/spell2/spell2lvl2_m with entity @s EnderItems[0].components.minecraft:custom_data
...
execute if score $no_cooldowns option_panel matches 0 if score @s spell2 matches 3 run function stuff:stuff_mage/cooldowns_m/spell2/spell2lvl3_m with entity @s EnderItems[0].components.minecraft:custom_data
