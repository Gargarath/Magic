...
execute store result bossbar trapped:player12 value run scoreboard players get @s trapped
...
execute if score @s trap_number_a matches 4 store result bossbar trapped_someone:player4 value run scoreboard players get @s trapped
