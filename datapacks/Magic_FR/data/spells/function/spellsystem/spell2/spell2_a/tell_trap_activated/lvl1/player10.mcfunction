...
bossbar set trapped_someone:player10 name ["",{"selector":"@a[scores={in_trap_number=10},limit=1]","bold":true},{"text":" est dans votre piège !","bold":true,"color":"dark_green"}]
bossbar set trapped_someone:player10 max 40
bossbar set trapped_someone:player10 value 40
