...
execute if score @s timer_rally_flag matches 216 run playsound minecraft:block.bell.use master @a[distance=..20] ~ ~ ~ 100 0
execute if score @s timer_rally_flag matches 212 run playsound minecraft:block.bell.use master @a[distance=..20] ~ ~ ~ 100 1

execute if score @s timer_rally_flag matches 200 run data merge entity @s {CustomName:"10"}
execute if score @s timer_rally_flag matches 180 run data merge entity @s {CustomName:"9"}
execute if score @s timer_rally_flag matches 160 run data merge entity @s {CustomName:"8"}
execute if score @s timer_rally_flag matches 140 run data merge entity @s {CustomName:"7"}
