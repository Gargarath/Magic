## appelée par spells:spellsystem/spell2/spell2_w/summon_flag/lvl2/testplayer si @s est le joueur 2
...
bossbar set rally_flag:player2 name {"text":"Drapeau de ralliement II","color":"gold"}
