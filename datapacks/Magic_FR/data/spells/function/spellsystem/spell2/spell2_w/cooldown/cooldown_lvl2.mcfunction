## appelée par un des player si le joueur a le sort au niveau 2
...
execute if score $no_cooldowns option_panel matches 0 run function stuff:stuff_warrior/cooldowns_w/spell2/spell2lvl2_w with entity @s EnderItems[0].components.minecraft:custom_data
