## appelée par spells:spellsystem/spell2/spell2_w/summon_flag/lvl1/testplayer si @s est le joueur 8
...
$bossbar set rally_flag:player8 name {"text":"$(tr_warrior_spell2_1_name)","color":"gold"}
