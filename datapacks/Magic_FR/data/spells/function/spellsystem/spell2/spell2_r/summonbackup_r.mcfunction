...
execute unless entity @s[tag=have_backup_r] run execute unless entity @e[tag=backup_r,scores={backup_number_r=1},type=armor_stand] run function spells:spellsystem/spell2/spell2_r/testbackup/testbackup1
...
execute unless entity @s[tag=have_backup_r] run execute unless entity @e[tag=backup_r,scores={backup_number_r=2},type=armor_stand] run function spells:spellsystem/spell2/spell2_r/testbackup/testbackup2
...
execute unless entity @s[tag=have_backup_r] run execute unless entity @e[tag=backup_r,scores={backup_number_r=3},type=armor_stand] run function spells:spellsystem/spell2/spell2_r/testbackup/testbackup3
...
execute unless entity @s[tag=have_backup_r] run execute unless entity @e[tag=backup_r,scores={backup_number_r=4},type=armor_stand] run function spells:spellsystem/spell2/spell2_r/testbackup/testbackup4
...
execute unless entity @s[tag=have_backup_r] run execute unless entity @e[tag=backup_r,scores={backup_number_r=5},type=armor_stand] run function spells:spellsystem/spell2/spell2_r/testbackup/testbackup5
...
execute unless entity @s[tag=have_backup_r] run execute unless entity @e[tag=backup_r,scores={backup_number_r=6},type=armor_stand] run function spells:spellsystem/spell2/spell2_r/testbackup/testbackup6
...
execute unless entity @s[tag=have_backup_r] run execute unless entity @e[tag=backup_r,scores={backup_number_r=7},type=armor_stand] run function spells:spellsystem/spell2/spell2_r/testbackup/testbackup7
...
execute unless entity @s[tag=have_backup_r] run execute unless entity @e[tag=backup_r,scores={backup_number_r=8},type=armor_stand] run function spells:spellsystem/spell2/spell2_r/testbackup/testbackup8
...
execute unless entity @s[tag=have_backup_r] run execute unless entity @e[tag=backup_r,scores={backup_number_r=9},type=armor_stand] run function spells:spellsystem/spell2/spell2_r/testbackup/testbackup9
...
execute unless entity @s[tag=have_backup_r] run execute unless entity @e[tag=backup_r,scores={backup_number_r=10},type=armor_stand] run function spells:spellsystem/spell2/spell2_r/testbackup/testbackup10
...
execute unless entity @s[tag=have_backup_r] run execute unless entity @e[tag=backup_r,scores={backup_number_r=11},type=armor_stand] run function spells:spellsystem/spell2/spell2_r/testbackup/testbackup11
...
execute unless entity @s[tag=have_backup_r] run execute unless entity @e[tag=backup_r,scores={backup_number_r=12},type=armor_stand] run function spells:spellsystem/spell2/spell2_r/testbackup/testbackup12
