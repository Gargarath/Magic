...
execute if score @s[tag=Has_Blue_flag] jump_crouch_time_a matches 5.. run function ctf:usespellwithflag/usespell_blueflag
execute if score @s[tag=Has_Red_flag] jump_crouch_time_a matches 5.. run function ctf:usespellwithflag/usespell_redflag
