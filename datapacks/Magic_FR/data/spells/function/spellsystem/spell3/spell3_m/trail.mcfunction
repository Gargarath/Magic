...
execute unless block ~ ~ ~ #spell_beam positioned ~ ~ ~ if block ~ ~-69 ~ purple_concrete run function spells:spellsystem/spell3/spell3_m/show_can_tp
execute unless block ~ ~ ~ #spell_beam positioned ~ ~ ~ unless block ~ ~-69 ~ purple_concrete run scoreboard players set @s tp_range -1
