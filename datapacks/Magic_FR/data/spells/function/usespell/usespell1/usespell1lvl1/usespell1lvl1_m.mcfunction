# Gere l'activation du spell1lvl1 par un joueur mage

tag @s remove save_inventory

scoreboard players set @s usespell 0
scoreboard players set @s cooldownspell1 20
...
execute if score $no_cooldowns option_panel matches 0 run function stuff:stuff_mage/cooldowns_m/spell1/spell1lvl1_m with entity @s EnderItems[0].components.minecraft:custom_data
