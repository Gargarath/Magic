...
execute as @s[tag=!Has_freeze_arrow,scores={Player=1}] run function stuff:stuff_archer/arrows/explosive_arrow/lvl2/player1
execute as @s[tag=!Has_freeze_arrow,scores={Player=2}] run function stuff:stuff_archer/arrows/explosive_arrow/lvl2/player2
execute as @s[tag=!Has_freeze_arrow,scores={Player=3}] run function stuff:stuff_archer/arrows/explosive_arrow/lvl2/player3
execute as @s[tag=!Has_freeze_arrow,scores={Player=4}] run function stuff:stuff_archer/arrows/explosive_arrow/lvl2/player4
execute as @s[tag=!Has_freeze_arrow,scores={Player=5}] run function stuff:stuff_archer/arrows/explosive_arrow/lvl2/player5
execute as @s[tag=!Has_freeze_arrow,scores={Player=6}] run function stuff:stuff_archer/arrows/explosive_arrow/lvl2/player6
execute as @s[tag=!Has_freeze_arrow,scores={Player=7}] run function stuff:stuff_archer/arrows/explosive_arrow/lvl2/player7
execute as @s[tag=!Has_freeze_arrow,scores={Player=8}] run function stuff:stuff_archer/arrows/explosive_arrow/lvl2/player8
execute as @s[tag=!Has_freeze_arrow,scores={Player=9}] run function stuff:stuff_archer/arrows/explosive_arrow/lvl2/player9
execute as @s[tag=!Has_freeze_arrow,scores={Player=10}] run function stuff:stuff_archer/arrows/explosive_arrow/lvl2/player10
execute as @s[tag=!Has_freeze_arrow,scores={Player=11}] run function stuff:stuff_archer/arrows/explosive_arrow/lvl2/player11
execute as @s[tag=!Has_freeze_arrow,scores={Player=12}] run function stuff:stuff_archer/arrows/explosive_arrow/lvl2/player12
