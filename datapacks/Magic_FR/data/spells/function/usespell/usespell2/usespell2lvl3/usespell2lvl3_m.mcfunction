...
execute as @s at @s positioned ~ ~1.5 ~ positioned ^ ^ ^1.5 if block ~ ~ ~ #spell_beam run function spells:spellsystem/spell2/spell2_m/spell2lvl3_m
clear @s minecraft:carrot_on_a_stick[minecraft:custom_data={spell2_m:1b,spell2_slot:1b}]

function spells:spellsystem/spell2/spell2_m/setup_bossbar/lvl3/test_player
