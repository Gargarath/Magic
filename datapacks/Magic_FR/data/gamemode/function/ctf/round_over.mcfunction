...
execute if score round bossbar matches 3 if score Bleus Flag_posed > Rouges Flag_posed run function gamemode:ctf/end_game/blue_win
...
execute if score round bossbar matches 3 if score Bleus Flag_posed < Rouges Flag_posed run function gamemode:ctf/end_game/red_win
...
execute if score round bossbar matches 4 if score Bleus Flag_posed = Rouges Flag_posed run function gamemode:ctf/end_game/draw
