...
execute if score $secondary_objectives option_panel matches 1 if score on golem matches 1 run function gamemode:ctf/secondary_objectives/bossfight/ruin_map/bossfight_loop
