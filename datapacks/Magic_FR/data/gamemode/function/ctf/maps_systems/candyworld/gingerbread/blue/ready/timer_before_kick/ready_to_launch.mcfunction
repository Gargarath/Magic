...
execute as @a[tag=gingerbread_area_blue] run function gamemode:ctf/maps_systems/candyworld/gingerbread/blue/ready/timer_before_kick/exit_area
# enlève les bossbar et timer pain d'épice des joueurs

function gamemode:ctf/maps_systems/candyworld/gingerbread/blue/feet_kick/feet_kick
# propulse @s