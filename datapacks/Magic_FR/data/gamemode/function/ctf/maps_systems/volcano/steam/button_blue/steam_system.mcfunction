...
execute if score blue steam_timer matches 250.. run execute positioned -600.0 147.65 509.5 as @a[distance=..10] run playsound minecraft:weather.rain.above master @s -600.0 147 509.5 1 0 1
