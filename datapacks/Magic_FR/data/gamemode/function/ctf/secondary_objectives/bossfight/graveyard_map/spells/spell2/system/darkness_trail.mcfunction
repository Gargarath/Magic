...
execute if block ~ ~ ~ air positioned ~ ~-1 ~ run execute unless entity @a[distance=..0.9,tag=!spell_immune] run execute positioned ^ ^ ^1 positioned ~ ~1 ~ run function gamemode:ctf/secondary_objectives/bossfight/graveyard_map/spells/spell2/system/darkness_trail
