...
execute if entity @s[tag=blue_team] run function gamemode:ctf/secondary_objectives/bossfight/ruin_map/win/blue_win
execute if entity @s[tag=red_team] run function gamemode:ctf/secondary_objectives/bossfight/ruin_map/win/red_win
