...
execute as @e[tag=lich,limit=1] at @s positioned ~ ~1.5 ~ run function gamemode:ctf/secondary_objectives/bossfight/graveyard_map/spells/spell2/system/darkness_trail