...
execute if score min_players golem matches 1 run bossbar set minecraft:secondary_objective max 100
...
execute if score min_players golem matches 2 run bossbar set minecraft:secondary_objective max 200
...
execute if score min_players golem matches 3 run bossbar set minecraft:secondary_objective max 300
...
execute if score min_players golem matches 4 run bossbar set minecraft:secondary_objective max 400
...
execute if score min_players golem matches 5 run bossbar set minecraft:secondary_objective max 500
...
execute if score min_players golem matches 6.. run bossbar set minecraft:secondary_objective max 600
