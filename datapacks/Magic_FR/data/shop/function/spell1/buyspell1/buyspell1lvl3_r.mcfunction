# Permet d'acheter le spell1 de niveau 3 pour l'assassin

scoreboard players remove @s PH 240
# Enlève 240Points d'honneur (monnaie à @s)
...
advancement grant @s only rogue:spell1lvl3_r
# Donne le haut fait "Embuscade III" à @s
