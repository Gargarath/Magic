# Permet d'acheter le spell1 de niveau 3 pour le guerrier

scoreboard players remove @s PH 200
# Enlève 200 Points d'honneur (monnaie à @s)
...
advancement grant @s only warrior:spell1lvl3_w
# Donne le haut fait "Berzerk III" à @s
