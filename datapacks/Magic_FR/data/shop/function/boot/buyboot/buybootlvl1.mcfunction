...
advancement grant @s[tag=warrior] only warrior:7_w
## Donne le haut fait "Bottes d'acrobate I" a @s si c'est un guerrier
advancement grant @s[tag=mage] only mage:1_m
## Donne le haut fait "Bottes d'acrobate I" a @s si c'est un mage
advancement grant @s[tag=rogue] only rogue:7_r
## Donne le haut fait "Bottes d'acrobate I" a @s si c'est un assassin
