...
$execute if score @s shop_history_can_redo matches 1 run data merge entity @n[type=item_display,tag=shop_redo_all_$(player)] {item:{id:"minecraft:oak_sign",count:1,components:{"minecraft:custom_model_data":{strings:["redo_all"]}}},start_interpolation:0,interpolation_duration:2,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0.05f],scale:[0.35f,0.35f,0.35f]}}
...
$execute if score @s shop_history_can_redo matches 1 run data merge entity @n[type=text_display,tag=shop_redo_text,tag=shop_redo_$(player)] {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.35f,0.35f,0.35f]}}
...
$execute if score @s shop_history_can_redo matches 1 run data merge entity @n[type=text_display,tag=shop_redo_all_text1,tag=shop_redo_all_$(player)] {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.35f,0.35f,0.35f]}}
...
$execute if score @s shop_history_can_redo matches 1 run data merge entity @n[type=text_display,tag=shop_redo_all_text2,tag=shop_redo_all_$(player)] {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.35f,0.35f,0.35f]}}
...
$execute if score @s shop_history_can_redo matches 1 run data merge entity @n[type=interaction,tag=shop_redo_$(player)] {width:0.40f,height:0.40f}
...
$execute if score @s shop_history_can_redo matches 1 run data merge entity @n[type=interaction,tag=shop_redo_all_$(player)] {width:0.40f,height:0.40f}
