# appelee par mage si @s n'a plus le meme niveau de spell1
## remet a jour uniquement le slot spell1 du mage

$execute if score @s spell1 matches 0 run item replace entity @s hotbar.$(slot_spell1_m) with air
