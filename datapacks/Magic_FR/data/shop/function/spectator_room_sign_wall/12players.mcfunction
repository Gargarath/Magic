# appelée par shop:shop_is_ready lorsqu'il y a 12 joueurs dans la partie, permet alors d'afficher les panneaux pour les observer
...
setblock 2 -49 61 oak_wall_sign[facing=north]{front_text:{messages:[{"text":"Observer :","color":"white","bold":true,"click_event":{"action":"run_command","command":"trigger spec_player6 add 1"}},"",{"nbt":"by_player.6.name","storage":"stats:leaderboards","interpret":true},""]},is_waxed:1b} replace
# place le panneau pour observer le joueur 6

setblock 1 -49 61 oak_wall_sign[facing=north]{front_text:{messages:[{"text":"Observer :","color":"white","bold":true,"click_event":{"action":"run_command","command":"trigger spec_player7 add 1"}},"",{"nbt":"by_player.7.name","storage":"stats:leaderboards","interpret":true},""]},is_waxed:1b} replace
# place le panneau pour observer le joueur 7

setblock 0 -49 61 oak_wall_sign[facing=north]{front_text:{messages:[{"text":"Observer :","color":"white","bold":true,"click_event":{"action":"run_command","command":"trigger spec_player8 add 1"}},"",{"nbt":"by_player.8.name","storage":"stats:leaderboards","interpret":true},""]},is_waxed:1b} replace
# place le panneau pour observer le joueur 8

setblock -1 -49 61 oak_wall_sign[facing=north]{front_text:{messages:[{"text":"Observer :","color":"white","bold":true,"click_event":{"action":"run_command","command":"trigger spec_player9 add 1"}},"",{"nbt":"by_player.9.name","storage":"stats:leaderboards","interpret":true},""]},is_waxed:1b} replace
# place le panneau pour observer le joueur 9

setblock -2 -49 61 oak_wall_sign[facing=north]{front_text:{messages:[{"text":"Observer :","color":"white","bold":true,"click_event":{"action":"run_command","command":"trigger spec_player10 add 1"}},"",{"nbt":"by_player.10.name","storage":"stats:leaderboards","interpret":true},""]},is_waxed:1b} replace
# place le panneau pour observer le joueur 10

setblock 1 -50 61 oak_wall_sign[facing=north]{front_text:{messages:[{"text":"Observer :","color":"white","bold":true,"click_event":{"action":"run_command","command":"trigger spec_player11 add 1"}},"",{"nbt":"by_player.11.name","storage":"stats:leaderboards","interpret":true},""]},is_waxed:1b} replace
# place le panneau pour observer le joueur 11

setblock -1 -50 61 oak_wall_sign[facing=north]{front_text:{messages:[{"text":"Observer :","color":"white","bold":true,"click_event":{"action":"run_command","command":"trigger spec_player12 add 1"}},"",{"nbt":"by_player.12.name","storage":"stats:leaderboards","interpret":true},""]},is_waxed:1b} replace
# place le panneau pour observer le joueur 12
...
scoreboard players enable @a[scores={Player=-1}] spec_player11
scoreboard players enable @a[scores={Player=-1}] spec_player12
