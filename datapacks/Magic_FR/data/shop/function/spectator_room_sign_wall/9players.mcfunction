# appelée par shop:shop_is_ready lorsqu'il y a 9 joueurs dans la partie, permet alors d'afficher les panneaux pour les observer
...
setblock -1 -49 61 oak_wall_sign[facing=north]{front_text:{messages:[{"text":"Observer :","color":"white","bold":true,"click_event":{"action":"run_command","command":"trigger spec_player8 add 1"}},"",{"nbt":"by_player.8.name","storage":"stats:leaderboards","interpret":true},""]},is_waxed:1b} replace
# place le panneau pour observer le joueur 8

setblock -2 -49 61 oak_wall_sign[facing=north]{front_text:{messages:[{"text":"Observer :","color":"white","bold":true,"click_event":{"action":"run_command","command":"trigger spec_player9 add 1"}},"",{"nbt":"by_player.9.name","storage":"stats:leaderboards","interpret":true},""]},is_waxed:1b} replace
