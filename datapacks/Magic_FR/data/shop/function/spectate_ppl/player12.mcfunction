...
tellraw @s [{"color":"gray","italic":true,"text":"Vous observez "},{"bold":false,"hover_event":{"action":"show_text","value":[{"text":"","color":"gray","italic":true}]},"interpret":true,"italic":true,"nbt":"by_player.12.name","storage":"stats:leaderboards"}," ",{"click_event":{"action":"run_command","command":"/trigger spec_stop add 1"},"color":"gray","hover_event":{"action":"show_text","value":[{"text":"Cliquez ici pour arrêter d'observer.","color":"gray","italic":true}]},"italic":true,"text":"cliquez ici","underlined":true},{"color":"gray","italic":true,"text":" pour arrêter d'observer ce joueur."}]
