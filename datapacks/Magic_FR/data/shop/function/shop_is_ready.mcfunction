...
#reset les frameroom
execute if score $build_reset option_panel matches 0 at @a[scores={Player=1..12}] positioned ~ ~-9 ~ at @e[tag=room,distance=..10] positioned ~ ~9 ~ run data merge block ~-4 ~1 ~ {front_text:{messages:[{"text":"Réinitialisation","color":"white","bold":false,"italic":true,"click_event":{"action":"run_command","command":"/trigger reset_frameroom"}},{"text":"des achats","color":"white","bold":false,"italic":true},{"text":"désactivée.","color":"white","bold":false,"italic":true},""]}}
execute if score $build_reset option_panel matches 1 at @a[scores={Player=1..12}] positioned ~ ~-9 ~ at @e[tag=room,distance=..10] positioned ~ ~9 ~ run data merge block ~-4 ~1 ~ {front_text:{messages:[{"text":"[Réinitialiser","color":"gold","bold":false,"italic":true,"click_event":{"action":"run_command","command":"/trigger reset_frameroom"}},{"text":"les achats","color":"gold","bold":false,"italic":true},{"text":"de la manche]","color":"gold","bold":false,"italic":true},""]}}
execute if score $build_reset option_panel matches 2 at @a[scores={Player=1..12}] positioned ~ ~-9 ~ at @e[tag=room,distance=..10] positioned ~ ~9 ~ run data merge block ~-4 ~1 ~ {front_text:{messages:["",{"text":"[Réinitialiser","color":"gold","bold":false,"italic":true,"click_event":{"action":"run_command","command":"/trigger reset_frameroom"}},{"text":"les achats]","color":"gold","bold":false,"italic":true},""]}}
