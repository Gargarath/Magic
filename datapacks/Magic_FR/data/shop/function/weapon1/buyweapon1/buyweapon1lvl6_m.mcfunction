# Permet d'acheter la weapon1 de niveau 6 pour le mage
...
advancement grant @s only mage:weapon1lvl6_m
# Donne le haut fait "Bâton de Mage VI" à @s

execute as @e[tag=weapon1,distance=..10,limit=1] run data merge entity @e[tag=weapon1,distance=..10,limit=1] {ItemRotation:0b,Item:{id:"minecraft:blaze_rod",count:1,components:{"minecraft:custom_name":"Bâton de Mage VII - 70 PH"}},ItemDropChance:1.0f}
