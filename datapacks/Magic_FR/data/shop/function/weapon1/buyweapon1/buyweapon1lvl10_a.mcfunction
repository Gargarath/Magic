# Permet d'acheter la weapon1 de niveau 10 pour l'archer
...
scoreboard players set @s[tag=archer] maxarrow 6
...
advancement grant @s only archer:weapon1lvl10_a
# Donne le haut fait "Arc de combat X" à @s
