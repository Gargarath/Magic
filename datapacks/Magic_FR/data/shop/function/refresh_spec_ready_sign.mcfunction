...
execute store result score $ready playercount if entity @a[scores={is_ready=1}]
# compte combien de joueurs sont prêt
$execute if score $ready playercount matches 0..1 run setblock 4 -49 58 oak_wall_sign[facing=west]{front_text:{messages:[{"text":"$(tr_shop_spec_waiting)","color":"white","bold":true},"",[{"score":{"name":"$ready","objective":"playercount"},"color":"green","bold":true},{"text":"/","color":"white","bold":true},{"score":{"name":"player_atstart","objective":"playercount"},"color":"white","bold":true},{"text":" $(tr_shop_spec_ready)","color":"white"}],""]},is_waxed:1b} replace
$execute if score $ready playercount matches 2.. run setblock 4 -49 58 oak_wall_sign[facing=west]{front_text:{messages:[{"text":"$(tr_shop_spec_waiting)","color":"white","bold":true},"",[{"score":{"name":"$ready","objective":"playercount"},"color":"green","bold":true},{"text":"/","color":"white","bold":true},{"score":{"name":"player_atstart","objective":"playercount"},"color":"white","bold":true},{"text":" $(tr_shop_spec_ready)$(tr_shop_spec_ready_plural)","color":"white"}],""]},is_waxed:1b} replace
