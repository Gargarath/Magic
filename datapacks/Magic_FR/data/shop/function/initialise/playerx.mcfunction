...
# boutons undo
$execute at @e[type=marker,tag=shop_room_$(player)] run summon item_display ~2 ~0.5 ~4.44 {item_display:"gui",Tags:["shop_undo","shop_undo_$(player)"],item:{id:"minecraft:oak_sign",count:1},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0.05f],scale:[0.72f,0.32f,0.5f]}}
$execute at @e[type=item_display,tag=shop_undo_$(player)] run summon text_display ~-0.12 ~-0.08 ~0.04 {see_through:0b,shadow:1b,alignment:"center",background:0,billboard:"fixed",Tags:["shop_undo","shop_undo_text","shop_undo_$(player)"],Rotation:[180F,0F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.42f,0.42f,0.42f]},text:[{"text":"Undo","bold":true,"color":"dark_gray"}]}
$execute at @e[type=item_display,tag=shop_undo_$(player)] run summon interaction ~ ~-0.18 ~0.4 {width:0.75f,height:0.35f,response:1b,Tags:["shop_clickable","shop_undo","shop_undo_$(player)"]}
# boutons redo
$execute at @e[type=marker,tag=shop_room_$(player)] run summon item_display ~-2 ~0.5 ~4.44 {item_display:"gui",Tags:["shop_redo","shop_redo_$(player)"],item:{id:"minecraft:oak_sign",count:1},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0.05f],scale:[0.72f,0.32f,0.5f]}}
$execute at @e[type=item_display,tag=shop_redo_$(player)] run summon text_display ~-0.12 ~-0.08 ~0.04 {see_through:0b,shadow:1b,alignment:"center",background:0,billboard:"fixed",Tags:["shop_redo","shop_redo_text","shop_redo_$(player)"],Rotation:[180F,0F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.42f,0.42f,0.42f]},text:[{"text":"Redo","bold":true,"color":"dark_gray"}]}
$execute at @e[type=item_display,tag=shop_redo_$(player)] run summon interaction ~ ~-0.18 ~0.4 {width:0.75f,height:0.35f,response:1b,Tags:["shop_clickable","shop_redo","shop_redo_$(player)"]}
