...
$execute at @e[type=item_display,tag=shop_spell1_$(player)] run summon text_display ~-0.45 ~-0.4 ~ {billboard:"fixed",Tags:["shop_spell1","shop_spell1_price","shop_spell1_$(player)"],Rotation:[180F,0F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.5f,0.5f,0.5f]},text:{"color":"green","text":"0"}}
...
$execute at @e[type=item_display,tag=shop_spell2_$(player)] run summon text_display ~-0.45 ~-0.4 ~ {billboard:"fixed",Tags:["shop_spell2","shop_spell2_price","shop_spell2_$(player)"],Rotation:[180F,0F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.5f,0.5f,0.5f]},text:{"color":"green","text":"0"}}
...
$execute at @e[type=item_display,tag=shop_spell3_$(player)] run summon text_display ~-0.45 ~-0.4 ~ {billboard:"fixed",Tags:["shop_spell3","shop_spell3_price","shop_spell3_$(player)"],Rotation:[180F,0F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.5f,0.5f,0.5f]},text:{"color":"green","text":"0"}}
