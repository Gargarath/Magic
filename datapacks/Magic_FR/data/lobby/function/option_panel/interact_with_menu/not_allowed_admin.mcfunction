...
$execute unless entity @a[scores={operator=2}] run tellraw @s ["",{"bold":false,"color":"red","shadow_color":-16777215,"text":"$(tr_admin_how_to_be_op_platform)"}]
$execute if entity @a[scores={operator=2}] run tellraw @s [{"bold":false,"color":"red","shadow_color":-16777215,"text":"$(tr_admin_cant_become_op_1) "},{"bold":false,"color":"gold","selector":"@a[scores={operator=2},limit=1]"},{"bold":false,"color":"red","shadow_color":-16777215,"text":" $(tr_admin_cant_become_op_2)"}]
