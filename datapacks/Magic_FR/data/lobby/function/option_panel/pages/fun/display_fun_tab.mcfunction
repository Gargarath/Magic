...
# enable no_cooldowns
execute at @n[type=item_display,tag=optn_menu_background] run summon text_display ~0.79 ~1.81 ~1.79 {line_width:300,billboard:"fixed",alignment:"left",see_through:0b,shadow:0b,Rotation:[0F,0F],Tags:["optn_menu","optn_menu_fun","optn_menu_fun_clickable","optn_menu_fun_no_cooldowns"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.3f,1.5f,1.3f]},text:[{"text":"                                                       \n\n"},{"bold":true,"color":"white","text":"Aucun temps de recharge :"}],background:0}
execute at @n[tag=optn_menu_background] run summon item_display ~-2.1 ~1.1 ~1.765 {billboard:"fixed",item_display:"head",Tags:["optn_menu","optn_menu_fun","optn_menu_fun_clickable","optn_menu_fun_no_cooldowns"],glow_color_override:16701501,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.1f,1.15f,1.1f]},item:{id:"minecraft:oak_sign",count:1,components:{"minecraft:custom_model_data":{strings:["no"]}}}}
...
execute at @n[type=item_display,tag=optn_menu_background] run summon text_display ~0.79 ~0.31 ~1.79 {line_width:300,billboard:"fixed",alignment:"left",see_through:0b,shadow:0b,Rotation:[0F,0F],Tags:["optn_menu","optn_menu_fun","optn_menu_fun_clickable","optn_menu_fun_no_cooldowns"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.3f,1.5f,1.3f]},text:[{"text":"                                                       \n\n"},{"bold":true,"color":"white","text":"Points d'honneur illimités :"}],background:0}
execute at @n[tag=optn_menu_background] run summon item_display ~-2.1 ~-0.51 ~1.765 {billboard:"fixed",item_display:"head",Tags:["optn_menu","optn_menu_fun","optn_menu_fun_clickable","optn_menu_fun_infinite_money"],glow_color_override:16701501,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.1f,1.15f,1.1f]},item:{id:"minecraft:oak_sign",count:1,components:{"minecraft:custom_model_data":{strings:["no"]}}}}
