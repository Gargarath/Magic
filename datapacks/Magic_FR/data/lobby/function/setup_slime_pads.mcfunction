...
## ILE MAPS
summon marker 14 99 0 {Tags:["jump_pads","jump_pads_main_maps"]}
...
## ILE STATS
summon marker 0 99 14 {Tags:["jump_pads","jump_pads_main_stats"]}
...
## ILE JUMP
summon marker -14 99 0 {Tags:["jump_pads","jump_pads_main_jump"]}
