...
# TITRE
execute at @e[type=marker,tag=map_display_spot,limit=1] run summon text_display ~-4.5 ~7 ~ {Rotation:[90F,0F],view_range:2f,billboard:"horizontal",line_width:200,default_background:0b,shadow:1b,see_through:0b,alignment:"center",Tags:["map_display","map_display_title"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[5.0f,5.0f,5.0f]},text:[{"underlined":false,"bold":true,"color":"gold","text":"Visiter les arènes"}],background:16711680}
