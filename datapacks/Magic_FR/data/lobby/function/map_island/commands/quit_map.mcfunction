...
execute store result score $map_2 map_spectator if entity @a[tag=spec_map2]
execute store result score $map_3 map_spectator if entity @a[tag=spec_map3]
execute store result score $map_4 map_spectator if entity @a[tag=spec_map4]
execute store result score $map_5 map_spectator if entity @a[tag=spec_map5]
