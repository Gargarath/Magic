...
# UPDATE MAP TITLE
execute if score $displayed_map map_display_position matches 1 run data merge entity @e[type=minecraft:text_display,tag=map_display_title_map1,limit=1] {text:[{"underlined":false,"bold":true,"color":"aqua","text":"Pirate"}]}
execute if score $displayed_map map_display_position matches 2 run data merge entity @e[type=minecraft:text_display,tag=map_display_title_map1,limit=1] {text:[{"underlined":false,"bold":true,"color":"red","text":"Cimetière"}]}
execute if score $displayed_map map_display_position matches 3 run data merge entity @e[type=minecraft:text_display,tag=map_display_title_map1,limit=1] {text:[{"underlined":false,"bold":true,"color":"dark_red","text":"Usine"}]}
execute if score $displayed_map map_display_position matches 4 run data merge entity @e[type=minecraft:text_display,tag=map_display_title_map1,limit=1] {text:[{"underlined":false,"bold":true,"color":"dark_red","text":"Volcan"}]}
execute if score $displayed_map map_display_position matches 5 run data merge entity @e[type=minecraft:text_display,tag=map_display_title_map1,limit=1] {text:[{"underlined":false,"bold":true,"color":"gray","text":"Ruine"}]}
execute if score $displayed_map map_display_position matches 6 run data merge entity @e[type=minecraft:text_display,tag=map_display_title_map1,limit=1] {text:[{"underlined":false,"bold":true,"color":"light_purple","text":"Bonbon"}]}