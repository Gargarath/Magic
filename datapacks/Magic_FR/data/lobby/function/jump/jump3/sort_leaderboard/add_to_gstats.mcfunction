...
execute store result storage stats:jump 3.rank6.cp1.min10 int 1 run scoreboard players get @s jump3_cp1_timer_min10_pr
execute store result storage stats:jump 3.rank6.cp1.min01 int 1 run scoreboard players get @s jump3_cp1_timer_min01_pr
execute store result storage stats:jump 3.rank6.cp1.sec10 int 1 run scoreboard players get @s jump3_cp1_timer_sec10_pr
execute store result storage stats:jump 3.rank6.cp1.sec01 int 1 run scoreboard players get @s jump3_cp1_timer_sec01_pr
execute store result storage stats:jump 3.rank6.cp1.dec10 int 1 run scoreboard players get @s jump3_cp1_timer_dec10_pr
execute store result storage stats:jump 3.rank6.cp1.dec01 int 1 run scoreboard players get @s jump3_cp1_timer_dec01_pr

execute store result storage stats:jump 3.rank6.cp2.min10 int 1 run scoreboard players get @s jump3_cp2_timer_min10_pr
execute store result storage stats:jump 3.rank6.cp2.min01 int 1 run scoreboard players get @s jump3_cp2_timer_min01_pr
execute store result storage stats:jump 3.rank6.cp2.sec10 int 1 run scoreboard players get @s jump3_cp2_timer_sec10_pr
execute store result storage stats:jump 3.rank6.cp2.sec01 int 1 run scoreboard players get @s jump3_cp2_timer_sec01_pr
execute store result storage stats:jump 3.rank6.cp2.dec10 int 1 run scoreboard players get @s jump3_cp2_timer_dec10_pr
execute store result storage stats:jump 3.rank6.cp2.dec01 int 1 run scoreboard players get @s jump3_cp2_timer_dec01_pr

execute store result storage stats:jump 3.rank6.cp3.min10 int 1 run scoreboard players get @s jump3_cp3_timer_min10_pr
execute store result storage stats:jump 3.rank6.cp3.min01 int 1 run scoreboard players get @s jump3_cp3_timer_min01_pr
execute store result storage stats:jump 3.rank6.cp3.sec10 int 1 run scoreboard players get @s jump3_cp3_timer_sec10_pr
execute store result storage stats:jump 3.rank6.cp3.sec01 int 1 run scoreboard players get @s jump3_cp3_timer_sec01_pr
execute store result storage stats:jump 3.rank6.cp3.dec10 int 1 run scoreboard players get @s jump3_cp3_timer_dec10_pr
execute store result storage stats:jump 3.rank6.cp3.dec01 int 1 run scoreboard players get @s jump3_cp3_timer_dec01_pr

execute store result storage stats:jump 3.rank6.cp4.min10 int 1 run scoreboard players get @s jump3_cp4_timer_min10_pr
execute store result storage stats:jump 3.rank6.cp4.min01 int 1 run scoreboard players get @s jump3_cp4_timer_min01_pr
execute store result storage stats:jump 3.rank6.cp4.sec10 int 1 run scoreboard players get @s jump3_cp4_timer_sec10_pr
execute store result storage stats:jump 3.rank6.cp4.sec01 int 1 run scoreboard players get @s jump3_cp4_timer_sec01_pr
execute store result storage stats:jump 3.rank6.cp4.dec10 int 1 run scoreboard players get @s jump3_cp4_timer_dec10_pr
execute store result storage stats:jump 3.rank6.cp4.dec01 int 1 run scoreboard players get @s jump3_cp4_timer_dec01_pr
