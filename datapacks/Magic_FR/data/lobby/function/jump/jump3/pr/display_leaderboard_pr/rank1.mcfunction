...
execute unless score #tmp jump3_cp5 matches 0 run tellraw @s ["  - Checkpoint n°5 : ",{"color":"green","nbt":"3.rank1.cp5.min10","storage":"stats:jump"},{"color":"green","nbt":"3.rank1.cp5.min01","storage":"stats:jump"},{"color":"white","text":":"},{"color":"green","nbt":"3.rank1.cp5.sec10","storage":"stats:jump"},{"color":"green","nbt":"3.rank1.cp5.sec01","storage":"stats:jump"},{"color":"white","text":":"},{"color":"green","nbt":"3.rank1.cp5.dec10","storage":"stats:jump"},{"color":"green","nbt":"3.rank1.cp5.dec01","storage":"stats:jump"}]
