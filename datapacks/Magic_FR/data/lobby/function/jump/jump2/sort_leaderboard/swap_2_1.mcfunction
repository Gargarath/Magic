...
execute store result storage stats:jump 2.rank1.cp1.min10 int 1 run scoreboard players get @s jump2_cp1_timer_min10_pr
execute store result storage stats:jump 2.rank1.cp1.min01 int 1 run scoreboard players get @s jump2_cp1_timer_min01_pr
execute store result storage stats:jump 2.rank1.cp1.sec10 int 1 run scoreboard players get @s jump2_cp1_timer_sec10_pr
execute store result storage stats:jump 2.rank1.cp1.sec01 int 1 run scoreboard players get @s jump2_cp1_timer_sec01_pr
execute store result storage stats:jump 2.rank1.cp1.dec10 int 1 run scoreboard players get @s jump2_cp1_timer_dec10_pr
execute store result storage stats:jump 2.rank1.cp1.dec01 int 1 run scoreboard players get @s jump2_cp1_timer_dec01_pr

execute store result storage stats:jump 2.rank1.cp2.min10 int 1 run scoreboard players get @s jump2_cp2_timer_min10_pr
execute store result storage stats:jump 2.rank1.cp2.min01 int 1 run scoreboard players get @s jump2_cp2_timer_min01_pr
execute store result storage stats:jump 2.rank1.cp2.sec10 int 1 run scoreboard players get @s jump2_cp2_timer_sec10_pr
execute store result storage stats:jump 2.rank1.cp2.sec01 int 1 run scoreboard players get @s jump2_cp2_timer_sec01_pr
execute store result storage stats:jump 2.rank1.cp2.dec10 int 1 run scoreboard players get @s jump2_cp2_timer_dec10_pr
execute store result storage stats:jump 2.rank1.cp2.dec01 int 1 run scoreboard players get @s jump2_cp2_timer_dec01_pr

execute store result storage stats:jump 2.rank1.cp3.min10 int 1 run scoreboard players get @s jump2_cp3_timer_min10_pr
execute store result storage stats:jump 2.rank1.cp3.min01 int 1 run scoreboard players get @s jump2_cp3_timer_min01_pr
execute store result storage stats:jump 2.rank1.cp3.sec10 int 1 run scoreboard players get @s jump2_cp3_timer_sec10_pr
execute store result storage stats:jump 2.rank1.cp3.sec01 int 1 run scoreboard players get @s jump2_cp3_timer_sec01_pr
execute store result storage stats:jump 2.rank1.cp3.dec10 int 1 run scoreboard players get @s jump2_cp3_timer_dec10_pr
execute store result storage stats:jump 2.rank1.cp3.dec01 int 1 run scoreboard players get @s jump2_cp3_timer_dec01_pr

execute store result storage stats:jump 2.rank1.cp4.min10 int 1 run scoreboard players get @s jump2_cp4_timer_min10_pr
execute store result storage stats:jump 2.rank1.cp4.min01 int 1 run scoreboard players get @s jump2_cp4_timer_min01_pr
execute store result storage stats:jump 2.rank1.cp4.sec10 int 1 run scoreboard players get @s jump2_cp4_timer_sec10_pr
execute store result storage stats:jump 2.rank1.cp4.sec01 int 1 run scoreboard players get @s jump2_cp4_timer_sec01_pr
execute store result storage stats:jump 2.rank1.cp4.dec10 int 1 run scoreboard players get @s jump2_cp4_timer_dec10_pr
execute store result storage stats:jump 2.rank1.cp4.dec01 int 1 run scoreboard players get @s jump2_cp4_timer_dec01_pr
...
data merge entity @e[type=minecraft:text_display,limit=1,tag=jump_2_leaderboard_rank1] {text:[{"bold":true,"color":"yellow","text":"1. "},{"color":"white","interpret":true,"nbt":"2.rank1.head","storage":"stats:jump"}," ",{"color":"green","interpret":true,"nbt":"2.rank1.name","storage":"stats:jump"},{"color":"gray","text":" - "},{"color":"green","bold":false,"nbt":"2.rank1.min10","storage":"stats:jump"},{"color":"green","bold":false,"nbt":"2.rank1.min01","storage":"stats:jump"},{"color":"white","text":":"},{"color":"green","bold":false,"nbt":"2.rank1.sec10","storage":"stats:jump"},{"color":"green","bold":false,"nbt":"2.rank1.sec01","storage":"stats:jump"},{"color":"white","text":":"},{"color":"green","bold":false,"nbt":"2.rank1.dec10","storage":"stats:jump"},{"color":"green","bold":false,"nbt":"2.rank1.dec01","storage":"stats:jump"}]}
