...
execute unless score $rank5 jump2_score < $rank4 jump2_score run execute as @a[tag=in_jump] run tellraw @s ["",{"text":"[","color":"yellow"},{entity:"@s",nbt:"EnderItems[0].components.minecraft:custom_data.tr_jump_leaderboard_title",plain:true,"color":"yellow"},{"text":" n\u00B02]","color":"yellow"},{"text":" - "},{"color":"green","interpret":true,"nbt":"2.rank5.name","storage":"stats:jump"},{"text":" "},{entity:"@s",nbt:"EnderItems[0].components.minecraft:custom_data.tr_jump_rank_taken",plain:true},{"text":" "},{entity:"@s",nbt:"EnderItems[0].components.minecraft:custom_data.tr_jump_rank_5",plain:true,"color":"yellow"},{"text":" "},{entity:"@s",nbt:"EnderItems[0].components.minecraft:custom_data.tr_jump_rank_in",plain:true},{"text":" "},{"color":"green","nbt":"2.rank5.min10","storage":"stats:jump","plain":true},{"color":"green","nbt":"2.rank5.min01","storage":"stats:jump","plain":true},{"color":"white","text":":"},{"color":"green","nbt":"2.rank5.sec10","storage":"stats:jump","plain":true},{"color":"green","nbt":"2.rank5.sec01","storage":"stats:jump","plain":true},{"color":"white","text":":"},{"color":"green","nbt":"2.rank5.dec10","storage":"stats:jump","plain":true},{"color":"green","nbt":"2.rank5.dec01","storage":"stats:jump","plain":true}]
