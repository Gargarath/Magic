...
$execute at @e[type=marker,tag=jump_spec,limit=1] run summon text_display ~ ~1.4 ~ {Rotation:[-45F,0F],view_range:2f,shadow:1b,shadow_strength:0f,billboard:"fixed",line_width:200,default_background:0b,see_through:0b,alignment:"center",Tags:["jump","jump_spec","jump_spec_title","jump_spec_title2","jump_spec_mode_title"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.2f,1.2f,1.2f]},text:[{"underlined":false,"bold":true,"color":"yellow","text":"$(tr_jump_spec_mode_title)"}],background:16711680}
...
$execute at @e[type=marker,tag=jump_spec,limit=1] run summon text_display ~ ~0.6 ~ {Rotation:[-45F,0F],view_range:2f,billboard:"fixed",line_width:200,default_background:0b,see_through:0b,alignment:"center",Tags:["jump","jump_spec","jump_spec_title","jump_spec_title3","jump_spec_join"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.1f,1.1f,1.1f]},text:[{"underlined":false,"bold":true,"color":"gold","text":"[$(tr_jump_spec_mode_join)]"}],background:16711680}
