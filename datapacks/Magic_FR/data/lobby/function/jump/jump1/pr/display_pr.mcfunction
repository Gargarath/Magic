...
tellraw @s [{"color":"gold","text":"\n-- Statistiques de "},{"color":"white","interpret":true,"nbt":"temp.head","storage":"stats:jump"}," ",{"color":"green","interpret":true,"nbt":"temp.name","storage":"stats:jump"},{"color":"yellow","text":" parcours n°1"},{"color":"gold","text":" --"}]
...
execute unless score @s jump1_score_pr matches 1000000 if score @s jump1_cp1_pr matches 0 run tellraw @s ["  - Checkpoint n°1 : ",{"color":"green","text":"—"}]
...
execute unless score @s jump1_score_pr matches 1000000 if score @s jump1_cp2_pr matches 0 run tellraw @s ["  - Checkpoint n°2 : ",{"color":"green","text":"—"}]
