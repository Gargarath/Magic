...
execute if data storage stats:jump 1.rank6{name:""} run return run tellraw @s [{"color":"gray","text":"* Aucune donnée *"}]
# si le storage est vide -> annule et renvoi aucune donnée

tellraw @s [{"color":"gold","text":"\n-- Record de "},{"text":"6. ","color":"yellow"},{"color":"white","interpret":true,"nbt":"1.rank6.head","storage":"stats:jump"}," ",{"color":"green","interpret":true,"nbt":"1.rank6.name","storage":"stats:jump"},{"color":"yellow","text":" parcours n°1"},{"color":"gold","text":" --"}]

tellraw @s ["Meilleur temps : ",{"color":"green","nbt":"1.rank6.min10","storage":"stats:jump","plain":true},{"color":"green","nbt":"1.rank6.min01","storage":"stats:jump","plain":true},{"color":"white","text":":"},{"color":"green","nbt":"1.rank6.sec10","storage":"stats:jump","plain":true},{"color":"green","nbt":"1.rank6.sec01","storage":"stats:jump","plain":true},{"color":"white","text":":"},{"color":"green","nbt":"1.rank6.dec10","storage":"stats:jump","plain":true},{"color":"green","nbt":"1.rank6.dec01","storage":"stats:jump","plain":true}," - ",{"color":"green","nbt":"1.rank6.fall_pr","storage":"stats:jump","plain":true}," chute(s)"]

execute store result score #tmp jump1_cp1 run data get storage stats:jump 1.rank6.cp1.time

execute unless score #tmp jump1_cp1 matches 0 run tellraw @s ["  - Checkpoint n°1 : ",{"color":"green","nbt":"1.rank6.cp1.min10","storage":"stats:jump","plain":true},{"color":"green","nbt":"1.rank6.cp1.min01","storage":"stats:jump","plain":true},{"color":"white","text":":"},{"color":"green","nbt":"1.rank6.cp1.sec10","storage":"stats:jump","plain":true},{"color":"green","nbt":"1.rank6.cp1.sec01","storage":"stats:jump","plain":true},{"color":"white","text":":"},{"color":"green","nbt":"1.rank6.cp1.dec10","storage":"stats:jump","plain":true},{"color":"green","nbt":"1.rank6.cp1.dec01","storage":"stats:jump","plain":true}]
