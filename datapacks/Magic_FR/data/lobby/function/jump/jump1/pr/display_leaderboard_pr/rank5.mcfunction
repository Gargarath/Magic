...
tellraw @s [{"text":"\nTentatives totales sur le parcours : "},{"color":"green","nbt":"1.rank5.tries","storage":"stats:jump"}]
tellraw @s [{"text":"Chutes totales sur le parcours : "},{"color":"green","nbt":"1.rank5.fall","storage":"stats:jump"}]