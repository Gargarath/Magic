...
execute unless score $rank3 jump1_score < $rank2 jump1_score run execute as @a[tag=in_jump] run tellraw @s ["",{"text":"[","color":"yellow"},{entity:"@s",nbt:"EnderItems[0].components.minecraft:custom_data.tr_jump_leaderboard_title",plain:true,"color":"yellow"},{"text":" n\u00B01]","color":"yellow"},{"text":" - "},{"color":"green","interpret":true,"nbt":"1.rank3.name","storage":"stats:jump"},{"text":" "},{entity:"@s",nbt:"EnderItems[0].components.minecraft:custom_data.tr_jump_rank_taken",plain:true},{"text":" "},{entity:"@s",nbt:"EnderItems[0].components.minecraft:custom_data.tr_jump_rank_3",plain:true,"color":"yellow"},{"text":" "},{entity:"@s",nbt:"EnderItems[0].components.minecraft:custom_data.tr_jump_rank_in",plain:true},{"text":" "},{"color":"green","nbt":"1.rank3.min10","storage":"stats:jump","plain":true},{"color":"green","nbt":"1.rank3.min01","storage":"stats:jump","plain":true},{"color":"white","text":":"},{"color":"green","nbt":"1.rank3.sec10","storage":"stats:jump","plain":true},{"color":"green","nbt":"1.rank3.sec01","storage":"stats:jump","plain":true},{"color":"white","text":":"},{"color":"green","nbt":"1.rank3.dec10","storage":"stats:jump","plain":true},{"color":"green","nbt":"1.rank3.dec01","storage":"stats:jump","plain":true}]
