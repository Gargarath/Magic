...
execute as @a[tag=mm_needs,sort=random,limit=1] run function lobby:check_game_startable/matchmaking/attribution/assign_one_player
# Prend un joueur au hasard qui a encore besoin d'une affectation


execute if entity @a[tag=mm_needs] run schedule function lobby:check_game_startable/matchmaking/attribution/attribution_loop 1t
