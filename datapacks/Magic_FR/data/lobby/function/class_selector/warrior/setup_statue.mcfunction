...
summon text_display ^ ^12.5 ^ {billboard:"horizontal",see_through:0b,Tags:["class_selector","warrior_selector","warrior_selector_title"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[8f,8f,8f]},text:{"bold":true,"color":"gold","text":"Guerrier",shadow_color:-13487566},background:16711680}
# warrior title
summon text_display ^ ^11 ^-0.5 {billboard:"horizontal",line_width:300,default_background:0b,shadow:1b,see_through:0b,alignment:"left",Tags:["class_selector","warrior_selector","warrior_selector_description"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f]},text:[{"bold":true,"color":"white","text":"Spécialiste du combat rapproché, votre capacité à encaisser les coups et votre grosse hache vous donnent un avantage certain au corps à corps !"}],background:16711680}
# warrior description

## PASSIF
summon text_display ^-4 ^9 ^-0.5 {billboard:"horizontal",line_width:300,default_background:0b,shadow:1b,see_through:0b,alignment:"left",Tags:["class_selector","warrior_selector","warrior_selector_top_menu","warrior_selector_passive_text"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f]},text:[{"underlined":false,"bold":false,"color":"white","text":"Passif"}],background:16711680}
# text
...
## WEAPON
summon text_display ^-2 ^9 ^-0.5 {billboard:"horizontal",line_width:300,default_background:0b,shadow:1b,see_through:0b,alignment:"left",Tags:["class_selector","warrior_selector","warrior_selector_top_menu","warrior_selector_weapon1_text"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f]},text:[{"underlined":false,"bold":false,"color":"white","text":"Arme"}],background:16711680}
# text
...
## SPELL1
summon text_display ^ ^9 ^-0.5 {billboard:"horizontal",line_width:300,default_background:0b,shadow:1b,see_through:0b,alignment:"left",Tags:["class_selector","warrior_selector","warrior_selector_top_menu","warrior_selector_spell1_text"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f]},text:[{"underlined":false,"bold":false,"color":"white","text":"Sort 1"}],background:16711680}
# text
...
## SPELL2
summon text_display ^2 ^9 ^-0.5 {billboard:"horizontal",line_width:300,default_background:0b,shadow:1b,see_through:0b,alignment:"left",Tags:["class_selector","warrior_selector","warrior_selector_top_menu","warrior_selector_spell2_text"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f]},text:[{"underlined":false,"bold":false,"color":"white","text":"Sort 2"}],background:16711680}
# text
...
## SPELL3
summon text_display ^4 ^9 ^-0.5 {billboard:"horizontal",line_width:300,default_background:0b,shadow:1b,see_through:0b,alignment:"left",Tags:["class_selector","warrior_selector","warrior_selector_top_menu","warrior_selector_spell3_text"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f]},text:[{"underlined":false,"bold":false,"color":"white","text":"Sort 3"}],background:16711680}
# text
...
## DEVENIR GUERRIER
summon text_display ^-3.4 ^1.0 ^1 {billboard:"horizontal",line_width:100,default_background:0b,shadow:1b,see_through:0b,alignment:"center",Tags:["class_selector","warrior_selector","warrior_selector_selector"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.3f,1.3f,1.3f]},text:[{"underlined":false,"bold":true,"color":"yellow","text":"Choisir cette classe"}],background:16711680}
# text
