...
execute as @e[type=marker,tag=select_warrior_spot,limit=1] at @s run function lobby:class_selector/warrior/pages/passive/main with storage lobby:language translate
