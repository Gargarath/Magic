...
scoreboard players set $current_page class_selector_warrior 3
...
data modify entity @e[type=text_display,tag=warrior_selector_spell1_text,limit=1] text.underlined set value true
data modify entity @e[type=text_display,tag=warrior_selector_spell1_text,limit=1] text.color set value green
