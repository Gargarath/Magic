...
scoreboard players set $current_page class_selector_rogue 3
...
# spell3
summon interaction ^ ^0.7 ^ {width:0.8f,height:0.5,response:1b,Tags:["class_selector","rogue_selector","rogue_selector_top_menu","class_selector_rogue_clickable","rogue_left_arrow"]}
# left clickable
summon interaction ^3 ^0.7 ^ {width:0.8f,height:0.5,response:1b,Tags:["class_selector","rogue_selector","rogue_selector_top_menu","class_selector_rogue_clickable","rogue_right_arrow"]}
# right clickable
...
data modify entity @e[type=text_display,tag=rogue_selector_spell1_text,limit=1] text.underlined set value true
data modify entity @e[type=text_display,tag=rogue_selector_spell1_text,limit=1] text.color set value green
...
data merge entity @e[type=item_display,tag=rogue_selector_left_arrow,limit=1] {item:{id:"minecraft:oak_sign",count:1,components:{"minecraft:custom_model_data":{strings:["class_selector/left_arrow"]}}}}
# left_arrow
data merge entity @e[type=item_display,tag=rogue_selector_right_arrow,limit=1] {item:{id:"minecraft:oak_sign",count:1,components:{"minecraft:custom_model_data":{strings:["class_selector/right_arrow"]}}}}
# right_arrow