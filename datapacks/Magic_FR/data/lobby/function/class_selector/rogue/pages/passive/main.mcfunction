...
## TEXTE
data merge entity @e[type=text_display,tag=rogue_selector_text,limit=1] {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-0.5f,0f],scale:[1.2f,1.2f,1.2f]},text:["",{"atlas":"items","sprite":"item/golden_apple"}," ",{"underlined":true,"bold":true,"color":"yellow","text":"Régénération"},{"bold":true,"color":"green","text":"\n\nVos points de vie se régénèrent beaucoup plus rapidement.\n\n\n"},"\uE508 ",{"underlined":true,"bold":true,"color":"gray","text":"Icône de discrétion"},{"bold":true,"color":"green","text":"\n\nLorsque vous êtes invisible, une icone indique votre degré de discrétion."},"\n\n\uE508",{"bold":true,"color":"green","text":": Vous êtes accroupi, personne ne peut vous voir."},"\n\n\uE507",{"bold":true,"color":"green","text":": Vous marchez, les archers peuvent vous voir grâce à leur passif."},"\n\n\uE506",{"bold":true,"color":"green","text":": Vous sprintez, tout le monde peut vous voir grâce à vos traces de pas."}],background:16711680}
