...
scoreboard players set $current_page class_selector_rogue 5
...
data modify entity @e[type=text_display,tag=rogue_selector_spell3_text,limit=1] text.underlined set value true
data modify entity @e[type=text_display,tag=rogue_selector_spell3_text,limit=1] text.color set value green
