...
## TEXTE
data merge entity @e[type=text_display,tag=archer_selector_text,limit=1] {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-1f,0f],scale:[1.3f,1.3f,1.3f]},text:["",{"atlas":"items","sprite":"item/ender_eye"}," ",{"underlined":true,"bold":true,"color":"dark_green","text":"Vision elfique"},{"bold":true,"color":"green","text":"\n\nVous pouvez voir les joueurs adverses invisibles.\n\n\n"},{"atlas":"items","sprite":"item/arrow"}," ",{"underlined":true,"bold":true,"color":"dark_green","text":"Abondance de flèches"},{"bold":true,"color":"green","text":"\n\nVous récupérez une flèche 2 secondes après chaque tir.\n \nAméliorer votre arc vous permettra de stocker davantage de flèches sur vous.\n\n\n"},{"atlas":"gui","sprite":"jump_icon_a_10"}," ",{"underlined":true,"bold":true,"color":"dark_green","text":"Agilité elfique"},{"bold":true,"color":"green","text":"\n\nAccroupissez-vous pour augmenter votre hauteur de saut jusqu'à 2 blocs.\n\nLes grands sauts font tomber le drapeau."}],background:16711680}
