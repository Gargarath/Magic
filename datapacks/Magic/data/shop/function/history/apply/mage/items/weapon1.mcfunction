...
execute if score @s weapon1 matches 0 run function main:gui/reset_actionbar_bars
execute if score @s weapon1 matches 0 run function main:gui/display/refresh_gui
