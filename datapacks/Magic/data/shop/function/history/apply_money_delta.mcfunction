...
execute if score @s shop_history_delta_count matches 1 if score @s shop_history_delta_mode matches 1 run scoreboard players operation @s shop_history_money_spend -= @s shop_history_price
...
execute if score @s shop_history_delta_count matches 1 if score @s shop_history_delta_mode matches 2 run scoreboard players operation @s shop_history_money_spend += @s shop_history_price
