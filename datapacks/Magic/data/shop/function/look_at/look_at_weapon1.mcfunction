...
data merge entity @n[type=text_display,tag=shop_weapon1_level] {start_interpolation:0,interpolation_duration:2,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-0.2f,0.15f],scale:[0.5f,0.5f,0.5f]}}
...
$execute at @n[type=item_display,tag=shop_weapon1] run summon text_display ~-2.1 ~-0.5 ~-0.3 {line_width:250,see_through:0b,shadow:1b,alignment:"left",background:-14869215,billboard:"fixed",Tags:["shop_overlay","shop_overlay_$(player)","shop_overlay_weapon1","shop_overlay_weapon1_$(player)"],Rotation:[180F,0F],start_interpolation:0,interpolation_duration:1,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.5f,0.5f,0.5f]},text:["                                                       "]}
# invoque l'overlay
