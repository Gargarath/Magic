...
# boutons undo_all
$execute at @e[type=marker,tag=shop_room_$(player)] run summon item_display ~2.25 ~0.5 ~4.44 {item_display:"gui",Tags:["shop_undo","shop_undo_all_$(player)"],item:{id:"minecraft:oak_sign",count:1,components:{"minecraft:custom_model_data":{strings:["undo_all"]}}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0.05f],scale:[0.35f,0.35f,0.35f]}}
$execute at @e[type=item_display,tag=shop_undo_all_$(player)] run summon interaction ~ ~-0.25 ~0.2 {width:0.40f,height:0.40f,response:1b,Tags:["shop_clickable","shop_undo","shop_undo_all_$(player)"]}
...
# boutons undo
$execute at @e[type=marker,tag=shop_room_$(player)] run summon item_display ~1.75 ~0.5 ~4.44 {item_display:"gui",Tags:["shop_undo","shop_undo_$(player)"],item:{id:"minecraft:oak_sign",count:1,components:{"minecraft:custom_model_data":{strings:["undo"]}}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0.05f],scale:[0.35f,0.35f,0.35f]}}
$execute at @e[type=item_display,tag=shop_undo_$(player)] run summon interaction ~ ~-0.25 ~0.2 {width:0.40f,height:0.40f,response:1b,Tags:["shop_clickable","shop_undo","shop_undo_$(player)"]}
