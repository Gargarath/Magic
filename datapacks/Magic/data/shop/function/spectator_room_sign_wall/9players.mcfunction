...
$setblock -2 -49 61 oak_wall_sign[facing=north]{front_text:{messages:[{"text":"$(tr_shop_spec)","color":"white","bold":true,"click_event":{"action":"run_command","command":"trigger spec_player9 add 1"}},"",{"nbt":"by_player.9.name","storage":"stats:leaderboards","interpret":true},""]},is_waxed:1b} replace
