...
execute if score $gamemode option_panel matches 0 run function main:launch_arena/respawn_markers/ruin
# setup les marker de respawn si on est en mode FFA

execute if score shop enable_loop matches 0 as @a[scores={Player=1..}] run function main:launch_arena/setspawn_and_tp/ruin
