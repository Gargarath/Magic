...
$execute if score selected_map variables matches 7 run data modify storage personnal_storage.temp storage.map_name set value {"text":"$(tr_gui_map_7_name)","color":"dark_red","bold":true}
