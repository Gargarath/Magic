...
execute if score $gamemode option_panel matches 1 run data modify storage matchinfo.blue flag_state set value {"text":"\uE301"}
execute if score $gamemode option_panel matches 1 run data modify storage matchinfo.red flag_state set value {"text":"\uE304"}
