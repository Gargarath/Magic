...
clear @s oak_sign[custom_data={inventory_menu:1b,inventory_menu_op_menu_all_ready:1b}]
...
function main:admin/book_commands/all_ready with entity @s EnderItems[0].components.minecraft:custom_data
