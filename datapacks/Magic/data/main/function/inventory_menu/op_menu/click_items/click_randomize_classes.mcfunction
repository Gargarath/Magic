...
clear @s oak_sign[custom_data={inventory_menu:1b,inventory_menu_op_menu_randomize_classes:1b}]
...
function main:admin/book_commands/randomize_class with entity @s EnderItems[0].components.minecraft:custom_data
