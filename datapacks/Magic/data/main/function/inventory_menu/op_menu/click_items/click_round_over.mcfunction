...
clear @s oak_sign[custom_data={inventory_menu:1b,inventory_menu_op_menu_round_over:1b}]
...
function main:admin/book_commands/round_over with entity @s EnderItems[0].components.minecraft:custom_data
