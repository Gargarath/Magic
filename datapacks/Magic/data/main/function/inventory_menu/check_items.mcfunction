...
execute if entity @s[tag=!inventory_rebuilding] unless items entity @s inventory.17 oak_sign[custom_data={inventory_menu:1b,inventory_menu_language:1b}] unless data storage temp:inventory_menu {language_count:0} run function main:inventory_menu/click_language
