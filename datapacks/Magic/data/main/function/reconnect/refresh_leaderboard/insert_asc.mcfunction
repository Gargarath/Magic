## Insere @s dans by_stat.$(stat), ordre croissant.

$scoreboard players set $rank1 $(objective) 2147483647
$scoreboard players set $rank2 $(objective) 2147483647
$scoreboard players set $rank3 $(objective) 2147483647
$scoreboard players set $rank4 $(objective) 2147483647
$scoreboard players set $rank5 $(objective) 2147483647
$scoreboard players set $rank6 $(objective) 2147483647
$scoreboard players set $rank7 $(objective) 2147483647
$scoreboard players set $rank8 $(objective) 2147483647
$scoreboard players set $rank9 $(objective) 2147483647
$scoreboard players set $rank10 $(objective) 2147483647
$scoreboard players set $rank11 $(objective) 2147483647
$scoreboard players set $rank12 $(objective) 2147483647
