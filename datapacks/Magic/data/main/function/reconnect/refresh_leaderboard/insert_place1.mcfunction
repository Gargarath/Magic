...
$data modify storage stats:leaderboards by_stat.$(stat)."4" set from storage stats:leaderboards by_stat.$(stat)."3"
$data modify storage stats:leaderboards by_stat.$(stat)."3" set from storage stats:leaderboards by_stat.$(stat)."2"
$data modify storage stats:leaderboards by_stat.$(stat)."2" set from storage stats:leaderboards by_stat.$(stat)."1"
data modify storage temp:reconnect_insert macro.rank set value 1
