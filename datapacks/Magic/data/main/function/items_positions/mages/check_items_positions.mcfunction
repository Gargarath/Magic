## appelée par item_save_system si @s est un mage permet de sauvegarder l'équipement de @s

scoreboard players operation @s weapon1_slot2 = @s weapon1_slot_m
scoreboard players operation @s spell1_slot2 = @s spell1_slot_m
scoreboard players operation @s spell2_slot2 = @s spell2_slot_m
scoreboard players operation @s spell3_slot2 = @s spell3_slot_m
scoreboard players operation @s quit_slot2 = @s quit_slot_m
...
execute if score @s item_save_error matches 0 run function main:items_positions/mages/save_item_positions