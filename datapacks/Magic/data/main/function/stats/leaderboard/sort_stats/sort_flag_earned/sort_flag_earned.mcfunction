...
data modify storage stats:leaderboards by_stat.stat_flag_earned set value {}
...
scoreboard players reset * sort_flag_earned
scoreboard players set $current_check sort_flag_earned 0
# indique la position actuelle de détection


function main:stats/leaderboard/sort_stats/sort_flag_earned/sorting_clock
