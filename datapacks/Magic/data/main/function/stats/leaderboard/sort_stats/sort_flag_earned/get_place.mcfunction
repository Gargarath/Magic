...
execute store result storage temp:sort rank int 1 run scoreboard players get @s sort_flag_earned
...
function main:stats/leaderboard/sort_stats/sort_flag_earned/save_place with storage temp:sort
