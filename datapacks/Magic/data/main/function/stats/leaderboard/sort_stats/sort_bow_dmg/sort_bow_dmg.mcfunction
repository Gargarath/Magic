...
data modify storage stats:leaderboards by_stat.stat_bow_dmg set value {}
...
scoreboard players reset * sort_bow_dmg10
scoreboard players set $current_check sort_bow_dmg10 0
# indique la position actuelle de détection


function main:stats/leaderboard/sort_stats/sort_bow_dmg/sorting_clock
