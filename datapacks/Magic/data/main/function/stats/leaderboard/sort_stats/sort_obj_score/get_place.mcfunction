...
execute store result storage temp:sort rank int 1 run scoreboard players get @s sort_obj_score
...
function main:stats/leaderboard/sort_stats/sort_obj_score/save_place with storage temp:sort
