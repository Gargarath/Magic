...
execute store result storage temp:sort rank int 1 run scoreboard players get @s sort_total_dmg
...
function main:stats/leaderboard/sort_stats/sort_total_dmg/save_place with storage temp:sort
