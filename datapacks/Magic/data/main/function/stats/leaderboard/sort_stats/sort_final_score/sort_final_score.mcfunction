...
data modify storage stats:leaderboards by_stat.stat_final_score set value {}
...
scoreboard players reset * sort_final_score
scoreboard players set $current_check sort_final_score 0
# indique la position actuelle de détection


function main:stats/leaderboard/sort_stats/sort_final_score/sorting_clock
