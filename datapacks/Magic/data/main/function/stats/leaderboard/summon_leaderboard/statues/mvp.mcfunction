...
$execute as @e[type=minecraft:mannequin,limit=1,distance=..1] at @s run summon text_display ~ ~5.5 ~-0.5 {background:16777215,shadow:1b,billboard:"vertical",Tags:["leaderboard","leaderboard_mvp_title"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[2.5f,2.5f,2.5f]},text:{"bold":true,"color":"gold","text":"$(tr_stats_mvp)"}}
