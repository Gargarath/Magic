...
function main:stats/scoreboard/blue_team_info/save_data/place3
# save la place de @s

execute as @a[scores={blue_place=4..},limit=1] if score @a[scores={blue_place=3},limit=1] class_id >= @s class_id run function main:stats/scoreboard/blue_team_info/sort_blue
