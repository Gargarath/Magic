...
$data modify block 13 97 13 Items[{Slot:$(player_last_game)b}].components."minecraft:written_book_content".pages[1].raw.extra append value {nbt:'by_player.$(player_last_game).stat_kd_ratio1',"storage":"stats:leaderboards","plain":true,color:"gold",bold:1b}
$data modify block 13 97 13 Items[{Slot:$(player_last_game)b}].components."minecraft:written_book_content".pages[1].raw.extra append value {nbt:'by_player.$(player_last_game).kd_ratio_comma',"storage":"stats:leaderboards",interpret:1b,color:"gold",bold:1b}
$data modify block 13 97 13 Items[{Slot:$(player_last_game)b}].components."minecraft:written_book_content".pages[1].raw.extra append value {nbt:'by_player.$(player_last_game).stat_kd_ratio2',"storage":"stats:leaderboards","plain":true,color:"gold",bold:1b}
