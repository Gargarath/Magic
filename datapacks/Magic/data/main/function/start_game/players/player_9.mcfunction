# Fonction appellée par main:start_game/start_game permet de deffinir @s comme le joueur 9 de le tp dans la frameroom n°9
scoreboard players set @s Player 9
execute at @e[tag=room9] run tp @s ~ ~9 ~ 0 -5
execute at @e[tag=room9] run spawnpoint @s ~ ~9 ~
