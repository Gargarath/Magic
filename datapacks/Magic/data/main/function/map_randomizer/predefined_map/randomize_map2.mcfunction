...
## permet de sélectionner la deuxième map au hazard sans que ce soit comme les suivantes et de l'enregistrer
...
execute if score $already_taken map_selection matches 0 run scoreboard players operation second_map map_memories = selected_map variables
# si pas d'erreur -> enregistre la map

execute if score $already_taken map_selection matches 1 run function main:map_randomizer/predefined_map/randomize_map2
