...
execute if score $already_taken map_selection matches 0 run scoreboard players operation third_map map_memories = selected_map variables
# si pas d'erreur -> enregistre la map

execute if score $already_taken map_selection matches 1 run function main:map_randomizer/predefined_map/randomize_map3
