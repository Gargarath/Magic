...
execute if entity @s[tag=warrior_passive] on target at @e[type=marker,tag=select_warrior_spot,limit=1] run function lobby:class_selector/warrior/pages/passive/main with storage lobby:language translate
