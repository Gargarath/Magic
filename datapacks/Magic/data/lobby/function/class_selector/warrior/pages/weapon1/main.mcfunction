...
scoreboard players set $current_page class_selector_warrior 2
...
data modify entity @e[type=text_display,tag=warrior_selector_weapon1_text,limit=1] text.underlined set value true
data modify entity @e[type=text_display,tag=warrior_selector_weapon1_text,limit=1] text.color set value green
