...
function lobby:class_selector/give_classes/rogue
# rend @s rogue

execute at @s run playsound minecraft:block.note_block.harp master @s ~ ~ ~ 1 2

function lobby:class_selector/messages/became_rogue with entity @s EnderItems[0].components.minecraft:custom_data
