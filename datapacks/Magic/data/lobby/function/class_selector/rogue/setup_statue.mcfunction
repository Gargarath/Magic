...
$summon text_display ^ ^12.5 ^ {billboard:"horizontal",see_through:0b,Tags:["class_selector","rogue_selector","rogue_selector_title"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.3f,0f,0f],scale:[8f,8f,8f]},text:{"bold":true,"color":"gray","text":"$(tr_lobby_rogue_title)",shadow_color:-13487566},background:16711680}
# rogue title
$summon text_display ^ ^11 ^-0.5 {billboard:"horizontal",line_width:300,default_background:0b,shadow:1b,see_through:0b,alignment:"left",Tags:["class_selector","rogue_selector","rogue_selector_description"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.4f,0f],scale:[1.5f,1.5f,1.5f]},text:[{"bold":true,"color":"white","text":"$(tr_lobby_rogue_description)"}],background:16711680}
# rogue description

## PASSIF
$summon text_display ^-4 ^9 ^-0.5 {billboard:"horizontal",line_width:300,default_background:0b,shadow:1b,see_through:0b,alignment:"left",Tags:["class_selector","rogue_selector","rogue_selector_top_menu","rogue_selector_passive_text"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f]},text:[{"underlined":false,"bold":false,"color":"white","text":"$(tr_lobby_passive)"}],background:16711680}
# text
...
## SPELL1
$summon text_display ^ ^9 ^-0.5 {billboard:"horizontal",line_width:300,default_background:0b,shadow:1b,see_through:0b,alignment:"left",Tags:["class_selector","rogue_selector","rogue_selector_top_menu","rogue_selector_spell1_text"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f]},text:[{"underlined":false,"bold":false,"color":"white","text":"$(tr_lobby_spell1)"}],background:16711680}
# text
...
## SPELL2
$summon text_display ^2 ^9 ^-0.5 {billboard:"horizontal",line_width:300,default_background:0b,shadow:1b,see_through:0b,alignment:"left",Tags:["class_selector","rogue_selector","rogue_selector_top_menu","rogue_selector_spell2_text"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f]},text:[{"underlined":false,"bold":false,"color":"white","text":"$(tr_lobby_spell2)"}],background:16711680}
# text
...
## SPELL3
$summon text_display ^4 ^9 ^-0.5 {billboard:"horizontal",line_width:300,default_background:0b,shadow:1b,see_through:0b,alignment:"left",Tags:["class_selector","rogue_selector","rogue_selector_top_menu","rogue_selector_spell3_text"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f]},text:[{"underlined":false,"bold":false,"color":"white","text":"$(tr_lobby_spell3)"}],background:16711680}
# text
...
# left_arrow
$summon text_display ^1.4 ^0.88 ^ {billboard:"horizontal",line_width:300,default_background:0b,shadow:1b,see_through:0b,alignment:"center",Tags:["class_selector","rogue_selector","rogue_selector_level_text"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.3f,1.3f,1.3f]},text:[{"underlined":false,"bold":false,"color":"white","text":"$(tr_lobby_item_level) 1"}],background:16711680}
# text
...
## DEVENIR GUERRIER
$summon text_display ^-3.4 ^1.0 ^1 {billboard:"horizontal",line_width:100,default_background:0b,shadow:1b,see_through:0b,alignment:"center",Tags:["class_selector","rogue_selector","rogue_selector_selector"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.3f,1.3f,1.3f]},text:[{"underlined":false,"bold":true,"color":"yellow","text":"$(tr_lobby_choose_class)"}],background:16711680}
# text
