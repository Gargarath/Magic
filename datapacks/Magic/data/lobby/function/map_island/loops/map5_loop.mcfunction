...
execute as @a[tag=spec_map5] at @s unless entity @s[x=-589,y=145,z=-202,dx=140,dy=150,dz=190] run tp @s -528.5 161 -51.5
# tp les specs qui vont trop loins

function gamemode:ctf/maps_systems/ruin/loop_ruin
