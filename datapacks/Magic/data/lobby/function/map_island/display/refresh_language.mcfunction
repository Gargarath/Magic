...
$data merge entity @e[type=text_display,tag=map_display_title_main,limit=1] {text:[{"underlined":false,"bold":true,"color":"gold","text":"$(tr_lobby_map_visit_island_title)"}]}
$data merge entity @e[type=text_display,tag=map_display_title_subtitle,limit=1] {text:[{"underlined":false,"bold":true,"color":"gray","text":"* $(tr_lobby_map_visit_island_subtitle) *"}]}
