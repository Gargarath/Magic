...
$execute unless score @s jump_timer < @s jump2_score_pr run tellraw @s [{"text":"$(tr_jump_finished_1)"},{"text":"2"},{"text":"$(tr_jump_finished_2)"},{"color":"green","score":{"name":"@s","objective":"jump_timer_min10"}},{"color":"green","score":{"name":"@s","objective":"jump_timer_min01"}},{"color":"white","text":":"},{"color":"green","score":{"name":"@s","objective":"jump_timer_sec10"}},{"color":"green","score":{"name":"@s","objective":"jump_timer_sec01"}},{"color":"white","text":":"},{"color":"green","score":{"name":"@s","objective":"jump_timer_dec10"}},{"color":"green","score":{"name":"@s","objective":"jump_timer_dec01"}},{"text":" $(tr_jump_personal_record)","color":"gray","italic":true},{"color":"gray","italic":false,"score":{"name":"@s","objective":"jump2_timer_min10_pr"}},{"color":"gray","italic":false,"score":{"name":"@s","objective":"jump2_timer_min01_pr"}},{"color":"gray","italic":false,"text":":"},{"color":"gray","italic":false,"score":{"name":"@s","objective":"jump2_timer_sec10_pr"}},{"color":"gray","italic":false,"score":{"name":"@s","objective":"jump2_timer_sec01_pr"}},{"color":"gray","italic":false,"text":":"},{"italic":false,"color":"gray","score":{"name":"@s","objective":"jump2_timer_dec10_pr"}},{"color":"gray","italic":false,"score":{"name":"@s","objective":"jump2_timer_dec01_pr"}},{"color":"gray","italic":true,"text":")"}]
# si @s n'a pas battu son PR -> lui indique son score

execute if score @s jump_timer < @s jump2_score_pr run function lobby:jump/jump2/pr/new_pr with entity @s EnderItems[0].components.minecraft:custom_data
# si @s a battu son PR -> le change et lui indique

execute if score @s jump_timer < $rank6 jump2_score run function lobby:jump/jump2/sort_leaderboard/add_to_gstats with entity @s EnderItems[0].components.minecraft:custom_data
