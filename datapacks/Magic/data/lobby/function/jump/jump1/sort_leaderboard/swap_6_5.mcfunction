...
$execute unless score $rank5 jump1_score < $rank4 jump1_score as @a[tag=in_jump] run tellraw @s ["",{"text":"[","color":"yellow"},{"text":"$(tr_jump_leaderboard_title)","color":"yellow"},{"text":" n\u00B01]","color":"yellow"},{"text":" - "},{"color":"green","interpret":true,"nbt":"1.rank5.name","storage":"stats:jump"},{"text":" "},{"text":"$(tr_jump_rank_taken)"},{"text":" "},{"text":"$(tr_jump_rank_5)","color":"yellow"},{"text":" "},{"text":"$(tr_jump_rank_in)"},{"text":" "},{"color":"green","nbt":"1.rank5.min10","storage":"stats:jump","plain":true},{"color":"green","nbt":"1.rank5.min01","storage":"stats:jump","plain":true},{"color":"white","text":":"},{"color":"green","nbt":"1.rank5.sec10","storage":"stats:jump","plain":true},{"color":"green","nbt":"1.rank5.sec01","storage":"stats:jump","plain":true},{"color":"white","text":":"},{"color":"green","nbt":"1.rank5.dec10","storage":"stats:jump","plain":true},{"color":"green","nbt":"1.rank5.dec01","storage":"stats:jump","plain":true}]
