...
$execute unless score $rank6 jump3_score < $rank5 jump3_score as @a[tag=in_jump] run tellraw @s ["",{"text":"[","color":"yellow"},{"text":"$(tr_jump_leaderboard_title)","color":"yellow"},{"text":" n\u00B03]","color":"yellow"},{"text":" - "},{"color":"green","interpret":true,"nbt":"3.rank6.name","storage":"stats:jump"},{"text":" "},{"text":"$(tr_jump_rank_taken)"},{"text":" "},{"text":"$(tr_jump_rank_6)","color":"yellow"},{"text":" "},{"text":"$(tr_jump_rank_in)"},{"text":" "},{"color":"green","nbt":"3.rank6.min10","storage":"stats:jump","plain":true},{"color":"green","nbt":"3.rank6.min01","storage":"stats:jump","plain":true},{"color":"white","text":":"},{"color":"green","nbt":"3.rank6.sec10","storage":"stats:jump","plain":true},{"color":"green","nbt":"3.rank6.sec01","storage":"stats:jump","plain":true},{"color":"white","text":":"},{"color":"green","nbt":"3.rank6.dec10","storage":"stats:jump","plain":true},{"color":"green","nbt":"3.rank6.dec01","storage":"stats:jump","plain":true}]
# si @s est 6ème -> affiche aux autres
execute if score $rank6 jump3_score < $rank5 jump3_score run function lobby:jump/jump3/sort_leaderboard/swap_6_5 with entity @s EnderItems[0].components.minecraft:custom_data
# si @s est aussi meilleur que 5 -> swap

execute if score $rank5 jump3_score < $rank4 jump3_score run function lobby:jump/jump3/sort_leaderboard/swap_5_4 with entity @s EnderItems[0].components.minecraft:custom_data
# si @s est aussi meilleur que 4 -> swap

execute if score $rank4 jump3_score < $rank3 jump3_score run function lobby:jump/jump3/sort_leaderboard/swap_4_3 with entity @s EnderItems[0].components.minecraft:custom_data
# si @s est aussi meilleur que 3 -> swap

execute if score $rank3 jump3_score < $rank2 jump3_score run function lobby:jump/jump3/sort_leaderboard/swap_3_2 with entity @s EnderItems[0].components.minecraft:custom_data
# si @s est aussi meilleur que 2 -> swap

execute if score $rank2 jump3_score < $rank1 jump3_score run function lobby:jump/jump3/sort_leaderboard/swap_2_1 with entity @s EnderItems[0].components.minecraft:custom_data
