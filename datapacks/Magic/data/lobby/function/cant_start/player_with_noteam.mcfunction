...
$tellraw @s ["",{"text":"\n$(tr_cant_start_player_without_team)","color":"red"}]
...
execute as @a[scores={Player=0},tag=!blue_team,tag=!red_team] run function lobby:cant_start/messages/choose_team with entity @s EnderItems[0].components.minecraft:custom_data
