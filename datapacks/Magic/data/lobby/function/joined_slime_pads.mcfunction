...
execute positioned 17 99 0 if entity @s[distance=..4,tag=!in_map_display] if score $lobby_maps option_panel matches 0 run return run function lobby:map_island/jump_pads/disabled with entity @s EnderItems[0].components.minecraft:custom_data
