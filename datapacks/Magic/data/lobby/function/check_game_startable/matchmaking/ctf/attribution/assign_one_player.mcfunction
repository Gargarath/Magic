...
execute if score @s team_side matches 0 run function lobby:check_game_startable/matchmaking/ctf/attribution/pick_team with entity @s EnderItems[0].components.minecraft:custom_data
# donne une équipe à @s si il n'en a pas déjà une

execute if score @s class_id matches 0 run function lobby:check_game_startable/matchmaking/ctf/attribution/pick_class with entity @s EnderItems[0].components.minecraft:custom_data
