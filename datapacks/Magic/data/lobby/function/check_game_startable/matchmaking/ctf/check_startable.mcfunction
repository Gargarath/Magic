...
execute unless score player playercount matches 13.. if score $matchmaking option_panel matches 1 run function lobby:check_game_startable/matchmaking/ctf/check_enough_players
