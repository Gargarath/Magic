...
execute unless score team_error start_error matches 1.. if entity @a[scores={Player=0},tag=!blue_team,tag=!red_team] as @s run function lobby:cant_start/player_with_noteam
...
execute unless score team_error start_error matches 1.. if entity @a[scores={Player=0},tag=!warrior,tag=!archer,tag=!mage,tag=!rogue] as @s run function lobby:cant_start/player_with_noclass
