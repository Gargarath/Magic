...
execute if score $force_launch option_panel matches 0 if score team_error start_error matches 1.. run function lobby:cant_start/need_at_least_one_player_by_team with entity @s EnderItems[0].components.minecraft:custom_data
...
execute unless score team_error start_error matches 1.. if entity @a[scores={Player=0},tag=!blue_team,tag=!red_team] as @s run function lobby:cant_start/player_with_noteam with entity @s EnderItems[0].components.minecraft:custom_data
...
execute unless score team_error start_error matches 1.. if entity @a[scores={Player=0},tag=!warrior,tag=!archer,tag=!mage,tag=!rogue] as @s run function lobby:cant_start/player_with_noclass with entity @s EnderItems[0].components.minecraft:custom_data
