## appelée quand le serveur entre dans le lobby
# Désactive les collisions pour toutes les équipes attribuables dans le lobby.
...
team modify red_op collisionRule never
team modify blue_op collisionRule never
...
team modify lobby_ffa_1 collisionRule never
team modify lobby_ffa_2 collisionRule never
team modify lobby_ffa_3 collisionRule never
team modify lobby_ffa_4 collisionRule never
team modify lobby_ffa_5 collisionRule never
team modify lobby_ffa_6 collisionRule never
team modify lobby_ffa_7 collisionRule never
team modify lobby_ffa_8 collisionRule never
team modify lobby_ffa_9 collisionRule never
