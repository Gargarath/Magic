...
execute at @e[type=armor_stand,tag=blue_member2,limit=1] run summon text_display ~ ~2.2 ~ {billboard:"center",see_through:0b,shadow:1b,background:0,Tags:["team_member_name","blue_member_name","blue_member2_name"],text:{text:""}}
data modify entity @e[type=text_display,tag=blue_member2_name,limit=1] text set from block 14 97 13 front_text.messages[0]
