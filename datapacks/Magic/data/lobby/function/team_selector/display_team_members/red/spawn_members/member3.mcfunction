...
execute at @e[type=armor_stand,tag=red_member3,limit=1] run summon text_display ~ ~2.2 ~ {billboard:"center",see_through:0b,shadow:1b,background:0,Tags:["team_member_name","red_member_name","red_member3_name"],text:{text:""}}
data modify entity @e[type=text_display,tag=red_member3_name,limit=1] text set from block 14 97 13 front_text.messages[0]
