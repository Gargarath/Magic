...
scoreboard players operation $ph_start option_panel = @s optn_ph_start_custom
...
execute if score $ph_start option_panel matches ..-1 run scoreboard players set $ph_start option_panel 0
execute if score $ph_start option_panel matches 601.. run scoreboard players set $ph_start option_panel 600
