...
data merge entity @s {item:{id:"minecraft:oak_sign",count:1,components:{"minecraft:custom_model_data":{strings:["build_reset_never"]}}}}
kill @e[type=interaction,tag=optn_menu_shop_build_reset_never]

# interaction pour le build_round_only
summon interaction ~-0.65 ~-0.04 ~-0.2 {Glowing:1b,width:0.5f,height:0.6,response:1b,Tags:["optn_menu","optn_menu_shop_build_reset_round_only","optn_menu_lobby_clickable","optn_menu_clickable"]}
summon interaction ~-0.15 ~-0.04 ~-0.2 {Glowing:1b,width:0.5f,height:0.6,response:1b,Tags:["optn_menu","optn_menu_shop_build_reset_round_only","optn_menu_lobby_clickable","optn_menu_clickable"]}
summon interaction ~0.35 ~-0.04 ~-0.2 {Glowing:1b,width:0.5f,height:0.6,response:1b,Tags:["optn_menu","optn_menu_shop_build_reset_round_only","optn_menu_lobby_clickable","optn_menu_clickable"]}
summon interaction ~0.78 ~-0.04 ~-0.2 {Glowing:1b,width:0.5f,height:0.6,response:1b,Tags:["optn_menu","optn_menu_shop_build_reset_round_only","optn_menu_lobby_clickable","optn_menu_clickable"]}
