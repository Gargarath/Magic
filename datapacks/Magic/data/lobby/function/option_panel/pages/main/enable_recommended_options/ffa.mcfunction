## appelée par enable_recommended_options/enable si on est en FFA
# active les options recommandées propre au FFA

# lobby

# gamemode
scoreboard players set $kills_goal option_panel 15
