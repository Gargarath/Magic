...
$data merge entity @n[type=text_display,tag=optn_menu_button_yes_no,distance=..0.6] {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0.54f,0f,0f],scale:[1.0f,1.0f,1.0f]},text:[{"bold":true,"color":"black","text":"$(tr_optn_menu_button_yes)"}],background:0}