...
execute if data entity @s {SelectedItem:{components:{"minecraft:custom_data":{island_selector:1b}}}} run return run function lobby:hotbar_menu/island_selector/give_items with entity @s EnderItems[0].components.minecraft:custom_data
execute if data entity @s {SelectedItem:{components:{"minecraft:custom_data":{class_selector:1b}}}} run return run function lobby:hotbar_menu/class_selector/give_items with entity @s EnderItems[0].components.minecraft:custom_data
...
execute if score $gamemode option_panel matches 1 if data entity @s {SelectedItem:{components:{"minecraft:custom_data":{team_selector:1b}}}} run return run function lobby:hotbar_menu/team_selector/give_items with entity @s EnderItems[0].components.minecraft:custom_data
