...
execute if score @s[scores={Player=6},team=red] save_flag_time matches 1 run bossbar set saveflag:player6 name ["",{"text":"Récupération:","bold":true,"color":"red"}]
execute if score @s[scores={Player=6},team=blue] save_flag_time matches 1 run bossbar set saveflag:player6 color blue
execute if score @s[scores={Player=6},team=blue] save_flag_time matches 1 run bossbar set saveflag:player6 name ["",{"text":"Récupération:","bold":true,"color":"blue"}]
