...
execute if score round bossbar matches 1..3 if score $secondary_objectives option_panel matches 1 if score on secnd_objective matches 0 if score $minutes timers matches 4 if score $seconds timers matches 0 run function gamemode:ctf/secondary_objectives/launch_secondary_objective/launch_secondary_objectives
...
execute if score fireworks timer_fireworks matches 50 as @e[tag=Has_Blue_flag] run function gamemode:ctf/summon_fireworks
execute if score fireworks timer_fireworks matches 50 as @e[tag=Has_Red_flag] run function gamemode:ctf/summon_fireworks
...
# Fin de partie
execute if score $time timers matches 0 run function gamemode:ctf/round_over
# Si le timer est à 0 -> lance ctf:round_over
execute if score round bossbar matches 4 if score Bleus Flag_posed > Rouges Flag_posed run function gamemode:ctf/end_game/blue_win
# Déclare l'équipe bleue vainqueur si les bleus ont capturés plus de drapeaux que les rouges à la manche 3 (prolongations)
execute if score round bossbar matches 4 if score Bleus Flag_posed < Rouges Flag_posed run function gamemode:ctf/end_game/red_win
...
execute as @a[scores={IsAlive=606..620}] run function gamemode:ctf/respawns/respawn_hasflag

# Sans drapeau
scoreboard players add @a[scores={IsAlive=1..6}] IsAlive 1
execute as @a[scores={IsAlive=7..10}] run function gamemode:ctf/respawns/respawn
...
execute as @a[tag=Has_Red_flag,scores={IsAlive=501}] run function gamemode:ctf/dropflag/dropflag_redflag
...
execute as @a[tag=Has_Blue_flag,scores={IsAlive=501}] run function gamemode:ctf/dropflag/dropflag_blueflag
# Execute la fonction ctf:dropflag/dropflag_blueflag au nom de celui qui a 501 en IsAlive et le tag Has_Blue_flag (= est mort avec le drapeau bleu)
    ...
    # Gere les récupérations de drapeau adverse

# Rouge

execute at @e[tag=Blue_flag,tag=droped] as @a[team=red,distance=..0.9,tag=!cant_pickup_flag] if score @s[scores={using_berzerk=-1,in_smoke1=-1}] cap_flag_time matches 0..14 run function gamemode:ctf/capflag_droped/bossbar/detect_player_number
# augmente le score de cap_flag_time du joueur rouge en train de ramener son drapeau
execute as @a[scores={cap_flag_time=1..,using_berzerk=-1},team=red,tag=!cant_pickup_flag] at @s unless entity @e[tag=Blue_flag,tag=droped,distance=..0.9] run function gamemode:ctf/capflag_droped/stop_caping
# reset le score de cap_flag_time du joueur rouge qui ne ramène plus son drapeau et lui enleve la bossbar qui indique le temps de réccupération
execute at @e[tag=Blue_flag,tag=droped] as @a[team=red,distance=..0.9,tag=!cant_pickup_flag] if score @s[scores={using_berzerk=-1,in_smoke1=-1}] cap_flag_time matches 15.. run function gamemode:ctf/capflag_droped/capflag_blueflag
# ramene le drapeau rouge à sa base et reset la bossbar de celui qui le ramène

# Bleu

execute at @e[tag=Red_flag,tag=droped] as @a[team=blue,distance=..0.9,tag=!cant_pickup_flag] if score @s[scores={using_berzerk=-1,in_smoke1=-1}] cap_flag_time matches 0..14 run function gamemode:ctf/capflag_droped/bossbar/detect_player_number
# augmente le score de cap_flag_time du joueur rouge en train de ramener son drapeau
execute as @a[scores={cap_flag_time=1..,using_berzerk=-1},team=blue,tag=!cant_pickup_flag] at @s unless entity @e[tag=Red_flag,tag=droped,distance=..0.9] run function gamemode:ctf/capflag_droped/stop_caping
# reset le score de cap_flag_time du joueur rouge qui ne ramène plus son drapeau et lui enleve la bossbar qui indique le temps de réccupération
execute at @e[tag=Red_flag,tag=droped] as @a[team=blue,distance=..0.9,tag=!cant_pickup_flag] if score @s[scores={using_berzerk=-1,in_smoke1=-1}] cap_flag_time matches 15.. run function gamemode:ctf/capflag_droped/capflag_redflag
# ramene le drapeau rouge à sa base et reset la bossbar de celui qui le ramène

    # Gere les récupérations de drapeau alliés


# Rouge

execute at @e[tag=Red_flag,tag=droped] as @a[team=red,distance=..0.9,tag=!cant_pickup_flag] if score @s[scores={using_berzerk=-1,in_smoke1=-1}] save_flag_time matches 0..59 run function gamemode:ctf/saveflag/bossbar/detect_player_number
# augmente le score de save_flag_time du joueur rouge en train de ramener son drapeau
execute as @a[scores={save_flag_time=1..,using_berzerk=-1},team=red,tag=!cant_pickup_flag] at @s unless entity @e[tag=Red_flag,tag=droped,distance=..0.9] run function gamemode:ctf/saveflag/stop_saving
...
execute at @e[tag=Red_flag,tag=droped] as @a[team=red,distance=..0.9,tag=!cant_pickup_flag] if score @s[scores={using_berzerk=-1,in_smoke1=-1}] save_flag_time matches 60.. run function gamemode:ctf/saveflag/saveflag_redflag
# ramene le drapeau rouge à sa base et reset la bossbar de celui qui le ramène

# Bleu

execute at @e[tag=Blue_flag,tag=droped] as @a[team=blue,distance=..0.9,tag=!cant_pickup_flag] if score @s[scores={using_berzerk=-1,in_smoke1=-1}] save_flag_time matches 0..59 run function gamemode:ctf/saveflag/bossbar/detect_player_number
# augmente le score de save_flag_time du joueur rouge en train de ramener son drapeau
execute as @a[scores={save_flag_time=1..,using_berzerk=-1},team=blue,tag=!cant_pickup_flag] at @s unless entity @e[tag=Blue_flag,tag=droped,distance=..0.9] run function gamemode:ctf/saveflag/stop_saving
# reset le score de save_flag_time du joueur rouge qui ne ramène plus son drapeau et lui enleve la bossbar qui indique le temps de réccupération
execute at @e[tag=Blue_flag,tag=droped] as @a[team=blue,distance=..0.9,tag=!cant_pickup_flag] if score @s[scores={using_berzerk=-1,in_smoke1=-1}] save_flag_time matches 60.. run function gamemode:ctf/saveflag/saveflag_blueflag
# ramene le drapeau rouge à sa base et reset la bossbar de celui qui le ramène
