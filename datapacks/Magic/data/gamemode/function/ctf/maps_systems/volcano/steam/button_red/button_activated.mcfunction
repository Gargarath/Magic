...
scoreboard players set red steam_timer 600
# lance le timer de vapeur

summon text_display -598 162.9 477.8 {background:-263237809,NoGravity:1b,billboard:"center",Tags:["steam_button","steam_button_red"],text:{"text":"30","bold":true}}
