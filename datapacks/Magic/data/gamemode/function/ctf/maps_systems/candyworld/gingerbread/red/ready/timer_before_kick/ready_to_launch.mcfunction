...
execute as @a[tag=gingerbread_area_red] run function gamemode:ctf/maps_systems/candyworld/gingerbread/red/ready/timer_before_kick/exit_area
# enlève les bossbar et timer pain d'épice des joueurs

function gamemode:ctf/maps_systems/candyworld/gingerbread/red/feet_kick/feet_kick
# propulse @s