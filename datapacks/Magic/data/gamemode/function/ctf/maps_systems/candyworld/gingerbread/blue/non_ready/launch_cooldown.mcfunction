...
summon text_display -46.95 161.40 -709.00 {background:-263237809,NoGravity:1b,billboard:"center",Tags:["gringerbread_cooldown","gringerbread_cooldown_blue"],text:{"bold":true,"text":"En recharge : 10"}}
