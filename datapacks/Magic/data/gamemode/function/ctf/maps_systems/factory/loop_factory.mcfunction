...
execute as @a[scores={Player=-1,InLobby=0}] at @s unless entity @s[x=264,y=144,z=-35,dx=115,dy=32,dz=84] unless entity @a[scores={InShop=1},distance=..7] run tp @s 297.5 157 20.0 -125.3 5.3
