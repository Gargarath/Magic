...
# permet de faire bouger les tapis roulant du milieu dans le sens inverse
        ...
        # JOUEURS
execute as @a[gamemode=adventure,scores={trapped=-1,hooked_w=-1},x=308.9,y=155.3,z=-18.9,dx=0.5,dy=0.6,dz=55,tag=!conveyor_belt_blue_middle] at @s if data entity @s {OnGround:1b} run function gamemode:ctf/maps_systems/factory/conveyor_belt/blue_side/middle_conveyor_belt/joined_conveyor
execute as @a[gamemode=adventure,scores={trapped=-1,hooked_w=-1},tag=conveyor_belt_blue_middle] unless entity @s[x=308.9,y=155.3,z=-18.9,dx=0.5,dy=0.6,dz=55] run function gamemode:ctf/maps_systems/factory/conveyor_belt/blue_side/middle_conveyor_belt/left_conveyor
...
execute as @a[gamemode=adventure,tag=conveyor_belt_blue_middle,scores={conveyor_belt=2..},x=308.9,y=155.3,z=-18.9,dx=0.5,dy=0.6,dz=55] at @s run function gamemode:ctf/maps_systems/factory/conveyor_belt/blue_side/middle_conveyor_belt/move_state_1
