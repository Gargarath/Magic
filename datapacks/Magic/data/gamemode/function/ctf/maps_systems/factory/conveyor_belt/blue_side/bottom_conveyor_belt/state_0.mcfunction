...
# permet de faire bouger les tapis roulant du bas bleus dans le sens classique
        ...
        # JOUEURS
execute as @a[gamemode=adventure,scores={trapped=-1,hooked_w=-1},x=282.0,y=152.3,z=-2.1,dx=78,dy=0.6,dz=0.5,tag=!conveyor_belt_blue_bottom] if data entity @s {OnGround:1b} run function gamemode:ctf/maps_systems/factory/conveyor_belt/blue_side/bottom_conveyor_belt/joined_conveyor
execute as @a[gamemode=adventure,scores={trapped=-1,hooked_w=-1},tag=conveyor_belt_blue_bottom] unless entity @s[x=282.0,y=152.3,z=-2.1,dx=78,dy=0.6,dz=0.5] run function gamemode:ctf/maps_systems/factory/conveyor_belt/blue_side/bottom_conveyor_belt/left_conveyor
...
execute as @a[gamemode=adventure,tag=conveyor_belt_blue_bottom,scores={conveyor_belt=2..},x=282.0,y=152.3,z=-2.1,dx=78,dy=0.6,dz=0.5] at @s run function gamemode:ctf/maps_systems/factory/conveyor_belt/blue_side/bottom_conveyor_belt/move_state_0
