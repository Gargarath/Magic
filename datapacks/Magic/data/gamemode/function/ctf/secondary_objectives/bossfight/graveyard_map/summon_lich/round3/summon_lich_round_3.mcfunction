...
execute if score min_players lich matches 1 run bossbar set minecraft:secondary_objective max 150
...
execute if score min_players lich matches 2 run bossbar set minecraft:secondary_objective max 300
...
execute if score min_players lich matches 3 run bossbar set minecraft:secondary_objective max 450
...
execute if score min_players lich matches 4 run bossbar set minecraft:secondary_objective max 600
...
execute if score min_players lich matches 5 run bossbar set minecraft:secondary_objective max 750
...
execute if score min_players lich matches 6.. run bossbar set minecraft:secondary_objective max 900
