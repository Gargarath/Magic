...
execute if score min_players lich matches 1 run bossbar set secondary_objective:state max 100
...
execute if score min_players lich matches 2 run bossbar set secondary_objective:state max 200
...
execute if score min_players lich matches 3 run bossbar set secondary_objective:state max 300
...
execute if score min_players lich matches 4 run bossbar set secondary_objective:state max 400
...
execute if score min_players lich matches 5 run bossbar set secondary_objective:state max 500
...
execute if score min_players lich matches 6.. run bossbar set secondary_objective:state max 600
