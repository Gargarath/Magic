...
execute if entity @s[tag=blue_team] run function gamemode:ctf/secondary_objectives/bossfight/graveyard_map/win/blue_win
execute if entity @s[tag=red_team] run function gamemode:ctf/secondary_objectives/bossfight/graveyard_map/win/red_win
