...
execute if score min_players living_cherry matches 1 run bossbar set secondary_objective:state max 125
...
execute if score min_players living_cherry matches 2 run bossbar set secondary_objective:state max 250
...
execute if score min_players living_cherry matches 3 run bossbar set secondary_objective:state max 375
...
execute if score min_players living_cherry matches 4 run bossbar set secondary_objective:state max 500
...
execute if score min_players living_cherry matches 5 run bossbar set secondary_objective:state max 625
...
execute if score min_players living_cherry matches 6.. run bossbar set secondary_objective:state max 750
