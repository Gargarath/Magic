...
execute unless entity @a[tag=targetable] run function gamemode:ctf/secondary_objectives/bossfight/candyworld_map/ai/make_invulnerable_and_noai
# si il n'y a personne dans la zone -> rend la cerise invincible
execute if entity @a[tag=targetable] run function gamemode:ctf/secondary_objectives/bossfight/candyworld_map/ai/chose_spell
