...
execute if score round bossbar matches 1 run function gamemode:ctf/secondary_objectives/bossfight/candyworld_map/summon_cherry/round1/summon_cherry_round_1
execute if score round bossbar matches 2 run function gamemode:ctf/secondary_objectives/bossfight/candyworld_map/summon_cherry/round2/summon_cherry_round_2
execute if score round bossbar matches 3 run function gamemode:ctf/secondary_objectives/bossfight/candyworld_map/summon_cherry/round3/summon_cherry_round_3
