...
execute if score min_players golem matches 1 run bossbar set secondary_objective:state max 150
...
execute if score min_players golem matches 2 run bossbar set secondary_objective:state max 300
...
execute if score min_players golem matches 3 run bossbar set secondary_objective:state max 450
...
execute if score min_players golem matches 4 run bossbar set secondary_objective:state max 600
...
execute if score min_players golem matches 5 run bossbar set secondary_objective:state max 750
...
execute if score min_players golem matches 6.. run bossbar set secondary_objective:state max 900
