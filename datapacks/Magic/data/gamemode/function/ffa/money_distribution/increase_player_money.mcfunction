...
execute if score $passive_money option_panel matches 1.. as @a[scores={Player=1..,opt_passive_income_alert=1}] run function main:gui/ffa_money_alert/show_passive with entity @s EnderItems[0].components.minecraft:custom_data
...
schedule function gamemode:ffa/money_distribution/increase_player_money 7s
