...
execute if entity @s[tag=!Has_freeze_arrow] run function stuff:stuff_archer/arrows/explosive_arrow/lvl1 with entity @s EnderItems[0].components.minecraft:custom_data
