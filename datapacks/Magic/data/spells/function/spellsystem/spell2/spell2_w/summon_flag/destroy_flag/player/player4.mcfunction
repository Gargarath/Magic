## appelée par spells:spellsystem/spell2/spell2_w/summon_flag/destroy_flag/testplayer si @s est le joueur 4
## permet de clear son drapeau de ralliement et sa bossbar et de lancer son cd

bossbar set rally_flag:player4 players
...
kill @e[type=minecraft:armor_stand,tag=rally_flag_4]
kill @e[type=minecraft:area_effect_cloud,tag=rally_flag_4]