## appelée par loop/detect_cloud si @s est un nuage de niveau 3
...
execute if score @s cloudtimer_m matches 25.. positioned ~ ~-5 ~ run effect give @e[type=#spellable,distance=..5,tag=!spell_immune] minecraft:slowness 1 0 true
execute if score @s cloudtimer_m matches 60 positioned ~ ~-6 ~ run playsound minecraft:weather.rain master @a[distance=..40] ~ ~ ~ 100 0
execute if score @s cloudtimer_m matches 100 positioned ~ ~-6 ~ run playsound minecraft:weather.rain master @a[distance=..40] ~ ~ ~ 100 0
...
execute if score @s cloudtimer_m matches 170.. run kill @s