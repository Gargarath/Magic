...
execute if score @s burning_by_player matches 1 run damage @s 2 minecraft:magic by @a[scores={Player=1},limit=1]
execute if score @s burning_by_player matches 2 run damage @s 2 minecraft:magic by @a[scores={Player=2},limit=1]
execute if score @s burning_by_player matches 3 run damage @s 2 minecraft:magic by @a[scores={Player=3},limit=1]
execute if score @s burning_by_player matches 4 run damage @s 2 minecraft:magic by @a[scores={Player=4},limit=1]
execute if score @s burning_by_player matches 5 run damage @s 2 minecraft:magic by @a[scores={Player=5},limit=1]
execute if score @s burning_by_player matches 6 run damage @s 2 minecraft:magic by @a[scores={Player=6},limit=1]
execute if score @s burning_by_player matches 7 run damage @s 2 minecraft:magic by @a[scores={Player=7},limit=1]
execute if score @s burning_by_player matches 8 run damage @s 2 minecraft:magic by @a[scores={Player=8},limit=1]
execute if score @s burning_by_player matches 9 run damage @s 2 minecraft:magic by @a[scores={Player=9},limit=1]
execute if score @s burning_by_player matches 10 run damage @s 2 minecraft:magic by @a[scores={Player=10},limit=1]
execute if score @s burning_by_player matches 11 run damage @s 2 minecraft:magic by @a[scores={Player=11},limit=1]
execute if score @s burning_by_player matches 12 run damage @s 2 minecraft:magic by @a[scores={Player=12},limit=1]