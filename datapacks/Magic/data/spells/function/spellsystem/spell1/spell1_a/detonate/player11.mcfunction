...
kill @e[type=marker,tag=exploraycast11]
scoreboard players set @a[scores={Player=11},limit=1] explosive_arrow_timer -1
bossbar set explosive_arrow:player11 players

playsound minecraft:entity.generic.explode master @a[distance=..9] ~ ~ ~ 100 1
playsound minecraft:entity.generic.explode master @a[distance=10..,scores={Player=11}] ~ ~ ~ 100 1
particle minecraft:explosion ~ ~ ~ 0 0 0 0 1 force @a

execute if score @a[scores={Player=11},limit=1] spell1 matches 1 as @e[type=#spellable,tag=!spell_immune,distance=..7] at @s run function spells:spellsystem/spell1/spell1_a/detonate/summon_markers {id:11}
execute if score @a[scores={Player=11},limit=1] spell1 matches 2 as @e[type=#spellable,tag=!spell_immune,distance=..8] at @s run function spells:spellsystem/spell1/spell1_a/detonate/summon_markers {id:11}
execute if score @a[scores={Player=11},limit=1] spell1 matches 3 as @e[type=#spellable,tag=!spell_immune,distance=..9] at @s run function spells:spellsystem/spell1/spell1_a/detonate/summon_markers {id:11}
# spawn des markers autour des joueurs dans la zone rayon de 7/8/9 blocs

execute as @e[type=marker,tag=exploraycast11] run rotate @s facing ~ ~ ~
# fait regarder ses marquers vers ici

scoreboard players set @e[type=marker,tag=exploraycast11] explo_position_a 0
execute if score @a[scores={Player=11},limit=1] spell1 matches 1 if entity @e[type=#spellable,tag=!spell_immune,distance=..7] as @e[type=marker,tag=exploraycast11] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player11/dark_red
execute if score @a[scores={Player=11},limit=1] spell1 matches 2 if entity @e[type=#spellable,tag=!spell_immune,distance=..8] as @e[type=marker,tag=exploraycast11] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player11/dark_red
execute if score @a[scores={Player=11},limit=1] spell1 matches 3 if entity @e[type=#spellable,tag=!spell_immune,distance=..9] as @e[type=marker,tag=exploraycast11] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player11/dark_red
...
scoreboard players reset @e[type=#spellable,tag=!spell_immune,scores={hit_by_explo=11}] hit_by_explo
# clear toutes les cibles de cette flèche explo

scoreboard players operation @e[type=#spellable,tag=!spell_immune,tag=in_explo11,scores={last_caster=0}] hit_by_explo_charge = @s arrow_charge
execute if entity @s[tag=freeze_arrow] as @e[type=#spellable,tag=!spell_immune,tag=in_explo11] run function spells:spellsystem/spell3/spell3_a/get_frozen/player11/test_lvl
...
schedule function spells:spellsystem/spell1/spell1_a/arrow_hitted/player11 3t