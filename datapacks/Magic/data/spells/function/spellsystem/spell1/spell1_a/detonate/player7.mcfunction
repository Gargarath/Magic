...
execute if score @a[scores={Player=7},limit=1] spell1 matches 1 as @e[type=#spellable,tag=!spell_immune,distance=..10] at @s run function spells:spellsystem/spell1/spell1_a/detonate/summon_markers {id:7}
execute if score @a[scores={Player=7},limit=1] spell1 matches 2 as @e[type=#spellable,tag=!spell_immune,distance=..12] at @s run function spells:spellsystem/spell1/spell1_a/detonate/summon_markers {id:7}
execute if score @a[scores={Player=7},limit=1] spell1 matches 3 as @e[type=#spellable,tag=!spell_immune,distance=..15] at @s run function spells:spellsystem/spell1/spell1_a/detonate/summon_markers {id:7}
...
execute if score @a[scores={Player=7},limit=1] spell1 matches 1 if entity @e[type=#spellable,tag=!spell_immune,distance=..10] as @e[type=marker,tag=exploraycast7] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player7/dark_red
execute if score @a[scores={Player=7},limit=1] spell1 matches 2 if entity @e[type=#spellable,tag=!spell_immune,distance=..12] as @e[type=marker,tag=exploraycast7] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player7/dark_red
execute if score @a[scores={Player=7},limit=1] spell1 matches 3 if entity @e[type=#spellable,tag=!spell_immune,distance=..15] as @e[type=marker,tag=exploraycast7] positioned ~ ~ ~ facing entity @s feet run function spells:spellsystem/spell1/spell1_a/raycast/player7/dark_red
