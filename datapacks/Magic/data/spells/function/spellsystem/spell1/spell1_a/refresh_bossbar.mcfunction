...
execute if score @s Player matches 1 store result bossbar explosive_arrow:player1 value run scoreboard players get @s explosive_arrow_timer
execute if score @s Player matches 2 store result bossbar explosive_arrow:player2 value run scoreboard players get @s explosive_arrow_timer
execute if score @s Player matches 3 store result bossbar explosive_arrow:player3 value run scoreboard players get @s explosive_arrow_timer
execute if score @s Player matches 4 store result bossbar explosive_arrow:player4 value run scoreboard players get @s explosive_arrow_timer
execute if score @s Player matches 5 store result bossbar explosive_arrow:player5 value run scoreboard players get @s explosive_arrow_timer
execute if score @s Player matches 6 store result bossbar explosive_arrow:player6 value run scoreboard players get @s explosive_arrow_timer
execute if score @s Player matches 7 store result bossbar explosive_arrow:player7 value run scoreboard players get @s explosive_arrow_timer
execute if score @s Player matches 8 store result bossbar explosive_arrow:player8 value run scoreboard players get @s explosive_arrow_timer
execute if score @s Player matches 9 store result bossbar explosive_arrow:player9 value run scoreboard players get @s explosive_arrow_timer
execute if score @s Player matches 10 store result bossbar explosive_arrow:player10 value run scoreboard players get @s explosive_arrow_timer
execute if score @s Player matches 11 store result bossbar explosive_arrow:player11 value run scoreboard players get @s explosive_arrow_timer
execute if score @s Player matches 12 store result bossbar explosive_arrow:player12 value run scoreboard players get @s explosive_arrow_timer
