...
scoreboard players reset @e[type=#spellable,tag=!spell_immune,scores={hit_by_explo=8}] hit_by_explo
# clear toutes les cibles de cette flèche explo

scoreboard players operation @e[type=#spellable,tag=!spell_immune,tag=in_explo8,scores={last_caster=0}] hit_by_explo_charge = @s arrow_charge
execute if entity @s[tag=freeze_arrow] as @e[type=#spellable,tag=!spell_immune,tag=in_explo8] run function spells:spellsystem/spell3/spell3_a/get_frozen/player8/test_lvl
