...
scoreboard players set @e[type=#spellable,tag=!spell_immune,tag=in_explo10] last_caster 10
# tag pour check après 1 tick les pv des joueurs ou du boss - le tag dépend du numéro de joueur du caster

execute as @e[type=#spellable,tag=!spell_immune,tag=in_explo10] run function spells:spellsystem/spell1/spell1_a/took_spell1_a
