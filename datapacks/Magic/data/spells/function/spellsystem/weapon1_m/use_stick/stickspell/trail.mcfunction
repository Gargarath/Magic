...
execute if block ~ ~ ~ #spell_beam unless block ~ ~-45 ~ #spawn_protectors positioned ~ ~-1 ~ unless entity @a[distance=..0.9,tag=!spell_immune] positioned ^ ^ ^1 positioned ~ ~1 ~ run function spells:spellsystem/weapon1_m/use_stick/stickspell/scale_calculator
