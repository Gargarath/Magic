...
execute if score $no_cooldowns option_panel matches 0 if score @s Player matches 1..12 run scoreboard players set @s gui_actionbar_message 113
...
function stuff:stuff_archer/spell2/lvl3 with entity @s EnderItems[0].components.minecraft:custom_data
